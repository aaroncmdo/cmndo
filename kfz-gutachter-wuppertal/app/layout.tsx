...
export const metadata: Metadata = {
  ...
  title: 'Kfz-Gutachter Wuppertal · bei Unschuld 0 € · DAT',
  description:
    'Kfz-Gutachter Wuppertal — gerichtsfestes Gutachten, DAT-zertifiziert. Bei Unschuld 0 €. Anwalt & Mietwagen inklusive. Jetzt anrufen!',
