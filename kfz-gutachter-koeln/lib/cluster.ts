...
export const SEO_BODY: Record<string, SeoAbsatz[]> = {
  ...
  frechen: [
    ...
    { h3: 'Lkw streift Pkw: Warum die Anstoßhöhe alles entscheidet', text: `Bei einer Berührung zwischen Lkw und Pkw liegt der Kontaktpunkt selten dort, wo ein Pkw Struktur hat. Ein Aufliegerkotflügel oder ein Ladungsträger trifft auf Höhe der Fensterlinie, also oberhalb des Schwellers und oberhalb des Prallträgers — die Energie geht direkt in Dachrahmen, Säulen und Türoberkanten. Das Schadensbild wirkt dann harmlos, weil unten nichts zu sehen ist, während oben die Türen klemmen und die Scheibe im Rahmen spannt. Wichtig ist deshalb, die Anstoßhöhe zu vermessen und mit den Aufbaumaßen des beteiligten Lkw abzugleichen: Erst das belegt, welches Fahrzeug wo stand und wer die Spur verlassen hat. Ohne diese Messung steht später Aussage gegen Aussage.` },
    { h3: 'Das Restwertangebot der Versicherung: Warum Sie nicht sofort zusagen sollten', text: `Nach einem Totalschaden meldet sich die gegnerische Versicherung oft schnell mit einem konkreten Aufkäufer und einem Betrag, der über dem Restwert im Gutachten liegt. Das klingt nach Vorteil und ist meist keiner: Je höher der Restwert angesetzt wird, desto weniger bleibt von der Entschädigung übrig. Maßgeblich ist der Restwert, den ein Sachverständiger auf dem für Sie zugänglichen regionalen Markt ermittelt — nicht ein Gebot aus einer bundesweiten Online-Börse, an das Sie nicht gebunden sind. Verkaufen Sie das Fahrzeug nicht, bevor das Gutachten vorliegt und Sie die Zahlen kennen; danach entscheiden Sie in Ruhe, ob Sie das Angebot annehmen.` },
    { h3: 'Werkstattwahl — Ihr Recht, nicht das der Versicherung', text: `Sie entscheiden, wo repariert wird. Wir kennen verlässliche Karosserie- und Lackbetriebe in Frechen-Mitte, Königsdorf und Habbelrath, vom freien Fachbetrieb bis zur Markenwerkstatt, und die Abrechnung läuft über das Gutachten. Rechnen Sie fiktiv ab, also ohne tatsächliche Reparatur, gelten andere Regeln: Verbringungskosten und Ersatzteilaufschläge sind dann strittig, und eine spätere Nachforderung ist nur möglich, wenn die Reparatur belegt wird. Wir sagen Ihnen vorher, welcher Weg in Ihrem Fall mehr bringt.` },
    { h3: 'In drei Schritten zum Gutachten', text: `Melden, dokumentieren, abwickeln: Anruf oder WhatsApp, Vor-Ort-Termin meist binnen 60 Minuten in allen Ortsteilen, Gutachten binnen 48 Stunden. Bei Firmenfahrzeugen bringen Sie nach Möglichkeit den Fahrzeugschein und die Angaben zur betrieblichen Nutzung mit. Die Versicherungsabwicklung läuft parallel — für Sie kostenfrei.` },
  ...
  huerth: [
    ...
    { h3: 'Heckaufprall am Stauende: Was hinten wirklich kaputtgeht', text: `Beim Auffahrunfall federt der Stoßfänger zurück und sieht danach oft fast unversehrt aus — die Energie ist trotzdem geflossen. Sie läuft über den Prallträger in die Längsträger, und dort entstehen Stauchungen, die man erst auf der Richtbank misst. Darüber sitzt das Reserveradmuldenblech, das sich wellt, und der Kofferraumboden, dessen Schweißnähte aufreißen können. Kommt eine Anhängerkupplung dazu, leitet sie den Stoß punktuell in den Rahmen ein und verstärkt die Verformung. Bei stärkeren Anstößen lösen zudem die Gurtstraffer aus, was den Austausch der kompletten Gurteinheit nach sich zieht. Wir prüfen deshalb im Zweifel den Fehlerspeicher und die Karosseriemaße — genau die Positionen, die in einem Kostenvoranschlag über den Sichtschaden fehlen.` },
    { h3: 'Fiktiv abgerechnet: Wozu dient die Reparaturbestätigung?', text: `Sie dürfen den Schaden auf Gutachtenbasis auszahlen lassen und selbst entscheiden, ob und wie repariert wird. Zwei Ansprüche hängen aber daran, dass die Instandsetzung tatsächlich und fachgerecht erfolgt ist: der Nutzungsausfall für die Reparaturdauer und, bei der 130-Prozent-Abrechnung, der Anspruch überhaupt. Dafür gibt es die Reparaturbestätigung — eine kurze Nachbesichtigung, bei der der Sachverständige den Zustand nach der Arbeit dokumentiert. Wer sie sich spart, verliert im Streitfall den Nachweis, dass das Fahrzeug wieder verkehrssicher ist. Wir machen den Termin auf Wunsch direkt nach Abschluss der Reparatur, meist ohne dass Sie das Fahrzeug erneut abstellen müssen.` },
    { h3: 'Sind Sie an die Werkstatt der Versicherung gebunden?', text: `Nein. Verweist die Gegenseite auf eine „Partnerwerkstatt", ist das ein Vorschlag, keine Vorgabe. Wir vermitteln Betriebe in Hürth-Mitte, Hermülheim oder Efferen, und abgerechnet wird auf Basis des Gutachtens. Sinnvoll ist der Hinweis auf einen anderen Betrieb ohnehin nur, wenn er gleichwertig arbeitet und für Sie zumutbar erreichbar ist; bei einem jungen, scheckheftgepflegten Fahrzeug ist die Markenwerkstatt in aller Regel der maßgebliche Vergleich.` },
    { h3: 'So läuft Ihr Termin ab', text: `Kurzer Anruf oder WhatsApp, Vor-Ort-Termin meist binnen 60 Minuten, Gutachten binnen 48 Stunden. Wir kommen dorthin, wo das Fahrzeug steht — auch auf ein Firmen- oder Studiogelände, wenn der Zutritt geklärt ist. Die Regulierung läuft parallel; Sie müssen nichts vorstrecken und zahlen 0 €.` },
  ...
  wesseling: [
    ...
    { h3: 'Unterbodenschaden: der Schaden, den niemand sieht', text: `Wer über ein verlorenes Bauteil fährt oder auf einer verschmutzten Fahrbahn aufsetzt, hat oben nichts und unten viel. Zuerst trifft es die Verkleidung, dahinter liegen Ölwanne, Getriebegehäuse, Abgasanlage und die Leitungen für Kraftstoff und Bremse. Ein Riss in der Ölwanne zeigt sich erst nach Kilometern, ein angeschlagenes Bremsrohr unter Umständen erst beim nächsten starken Bremsen. Bei Fahrzeugen mit Luftfederung oder Allradantrieb kommen empfindliche Leitungen und Wellen hinzu. Deshalb gehört ein solcher Schaden auf die Hebebühne und nicht auf den Parkplatz: Die Aufnahme von unten ist der einzige Weg, den Umfang zu belegen, bevor die Versicherung ihn auf eine Verkleidung reduziert.` },
    { h3: 'Abschleppen, Standgeld, Verbringung: Wer trägt diese Kosten?', text: `Bei einem unverschuldeten Unfall gehören auch die Nebenkosten zum Schaden: das Abschleppen zur nächstgelegenen geeigneten Werkstatt, die Standkosten bis zur Begutachtung und die Verbringung zum Lackierbetrieb, wenn die Werkstatt keine eigene Lackiererei hat. Streit entsteht regelmäßig beim Standgeld, weil es täglich weiterläuft und die Gegenseite später behauptet, es sei unnötig lange aufgelaufen. Melden Sie den Schaden deshalb früh und lassen Sie das Fahrzeug zügig begutachten — dann ist belegt, dass die Standzeit dem Ablauf geschuldet war und nicht dem Zuwarten. Wir dokumentieren Abstellort und Datum mit und weisen die Nebenkosten getrennt aus.` },
    { h3: 'Werkstattbindung? Nicht beim Haftpflichtschaden', text: `Beim unverschuldeten Unfall wählen Sie die Werkstatt frei — anders als bei manchen Kaskotarifen mit vereinbarter Werkstattbindung. Wir vermitteln Karosserie- und Lackbetriebe in Wesseling-Mitte und Berzdorf und begleiten die Abrechnung über das Gutachten. Bei Nutzfahrzeugen und Aufbauten lohnt der Blick darauf, ob der Betrieb die passende Ausrüstung hat: Ein Rahmenschaden an einem Transporter braucht eine Richtbank mit entsprechender Aufnahme, nicht jeder Pkw-Betrieb hält sie vor.` },
    { h3: 'So kommen Sie zum Gutachten', text: `Anruf oder WhatsApp, Vor-Ort-Termin meist binnen 60 Minuten — auf Wunsch auch am Werkstor oder auf dem Firmenhof, sofern der Zutritt geregelt ist. Steht das Fahrzeug nach einem Schaden auf einem Werksgelände, klären wir die Zufahrt vorab mit Ihnen. Gutachten binnen 48 Stunden, Regulierung parallel, 0 € für Sie.` },
