...
export const SEO_BODY: Record<string, SeoAbsatz[]> = {
  ...
  leverkusen: [
    ...
    { h3: 'Welche Rechte haben Sie nach einem unverschuldeten Unfall?', text: `Sie wählen den Kfz-Gutachter selbst — nicht die gegnerische Versicherung. Wir arbeiten nach DAT- und BVSK-Standard und dokumentieren gerichtsfest, von der Bumper-Delle bis zum Strukturschaden:`, liste: LEISTUNGS_LISTE },
  ...
  'bergisch-gladbach': [
    ...
    { h3: 'Worauf kommt es bei der Gutachter-Wahl an?', text: `Neutralität, lokale Erfahrung, gerichtsfeste Dokumentation. Wir arbeiten nach DAT- und BVSK-Standard und dokumentieren unabhängig:`, liste: LEISTUNGS_LISTE },
  ...
  pulheim: [
    ...
    { h3: 'Welche Rechte haben Sie bei der Gutachter-Wahl?', text: `Sie wählen den Sachverständigen selbst — nicht die gegnerische Versicherung. Wir arbeiten nach DAT- und BVSK-Standard, ausschließlich in Ihrem Interesse:`, liste: LEISTUNGS_LISTE },
    ...
    { h3: 'Wer entscheidet über die Werkstatt?', text: `Sie. Der Sachverständige kennt verlässliche Partner in Pulheim-Mitte, Brauweiler und Stommeln — vom Karosseriefachbetrieb bis zur Lackiererei. Die Werkstatt rechnet auf Basis des Gutachtens ab, die Reparatur erfolgt fachgerecht nach DAT-Standard.` },
  ...
  bruehl: [
    ...
    { h3: 'Was leistet das Gutachten?', text: `Wir arbeiten nach DAT- und BVSK-Standard und dokumentieren gerichtsfest — auf Wunsch übernimmt der Verkehrsrechtsanwalt aus dem Claimondo-Netzwerk das komplette Abwicklungsmandat:`, liste: LEISTUNGS_LISTE },
  ...
  huerth: [
    ...
    { h3: 'Was gehört in ein gerichtsfestes Gutachten?', text: `Wir arbeiten nach DAT- und BVSK-Standard und dokumentieren vollständig:`, liste: LEISTUNGS_LISTE },
  ...
  wesseling: [
    ...
    { h3: 'Welche Rechte haben Sie bei der Gutachter-Wahl?', text: `Sie wählen den Sachverständigen selbst — nicht die gegnerische Versicherung. Wir arbeiten nach DAT- und BVSK-Standard und dokumentieren gerichtsfest:`, liste: LEISTUNGS_LISTE },
  ...
  kerpen: [
    ...
    { h3: 'Worauf kommt es bei der Gutachter-Wahl an?', text: `Neutralität, Geschwindigkeit, gerichtsfeste Dokumentation. Wir arbeiten nach DAT- und BVSK-Standard:`, liste: LEISTUNGS_LISTE },
  ...
  erftstadt: [
    ...
    { h3: 'Worauf kommt es bei der Gutachter-Wahl an?', text: `Neutralität, Geschwindigkeit, gerichtsfeste Dokumentation. Wir arbeiten nach DAT- und BVSK-Standard und ausschließlich in Ihrem Interesse:`, liste: LEISTUNGS_LISTE },
