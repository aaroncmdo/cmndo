...
- **Block 2 (Marketing-Split): Stream 1+2+3+4 + Stream 5 (Login-CTA) + Stream 6 (Tracking/Consent) KOMPLETT + public/-Assets (30.05.).** Build grün (116/116) + lokal gesmoked. **Pages + Login + Tracking fertig — nur noch Deploy-Strecke offen.**
- **Nächster Schritt:** Stream 7 (Deploy PM2 :3006 + vhost-Switch :3000→:3006 = PRODUKTIONSKRITISCH, braucht Aaron am VPS) → Stream 8 (301-Redirects App↔Marketing).
