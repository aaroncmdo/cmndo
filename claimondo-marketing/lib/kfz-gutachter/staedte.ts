...
export const STAEDTE: Stadt[] = [
  ...
  // Welle 6 (P3-B2b, 17.08.2026) — die 23 fehlenden NRW-Staedte ueber 60 Tsd.
  // Einwohnern. Damit ist NRW in dieser Groessenklasse vollstaendig abgedeckt.
  //
  // JEDE Gerichtskette einzeln bei ag-<name>.nrw.de/aufgaben/gerichtsbezirk belegt,
  // nicht aus der Nachbarschaft abgeleitet — die Zuordnung folgt KEINER Geografie:
  //   Dorsten und Gladbeck -> LG Essen, das nahe Castrop-Rauxel -> LG Dortmund
  //   Witten -> LG Bochum, das benachbarte Luedenscheid -> LG Hagen
  //   Kerpen und Bergheim -> LG Koeln, das nahe Grevenbroich -> LG Moenchengladbach
  // Genau diese Klasse stand in P1 auf 31 von 84 Seiten falsch.
  //
  // Herten hat als einzige KEIN eigenes Amtsgericht — zustaendig ist das AG
  // Recklinghausen (Datteln, Herten, Oer-Erkenschwick, Recklinghausen, Waltrop).
  // Die Kammer folgt dem OLG-Bezirk (Hamm / Duesseldorf / Koeln) und ist mit den
  // bestehenden Eintraegen desselben Landgerichts konsistent — der Invarianten-
  // Test in staedte.test.ts meldet jeden Widerspruch.
  //
  // Einwohner: Wikipedia-Liste der Staedte in NRW, Stand 31.12.2025.
  // Koordinaten und PLZ: Mapbox Places (Typ place bzw. postcode).
  {
    slug: 'guetersloh',
    name: 'Gütersloh',
    bundesland: 'Nordrhein-Westfalen',
  ...
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Bochum',
      amtsgericht: 'Amtsgericht Witten',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Witten',
  ...
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Mönchengladbach',
      amtsgericht: 'Amtsgericht Viersen',
      kammer: 'Rechtsanwaltskammer Düsseldorf',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Viersen',
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Münster',
      amtsgericht: 'Amtsgericht Rheine',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Rheine',
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Essen',
      amtsgericht: 'Amtsgericht Gladbeck',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Gladbeck',
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Essen',
      amtsgericht: 'Amtsgericht Dorsten',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Dorsten',
  },
  {
    ...
    lng: 8.0599,
    lokal: {
      landgericht: 'Landgericht Arnsberg',
  ...
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Köln',
      amtsgericht: 'Amtsgericht Kerpen',
      kammer: 'Rechtsanwaltskammer Köln',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Kerpen',
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Mönchengladbach',
      amtsgericht: 'Amtsgericht Grevenbroich',
      kammer: 'Rechtsanwaltskammer Düsseldorf',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Grevenbroich',
  },
  {
    slug: 'bergheim',
    name: 'Bergheim',
    ...
    lokal: {
      landgericht: 'Landgericht Köln',
      amtsgericht: 'Amtsgericht Bergheim',
      kammer: 'Rechtsanwaltskammer Köln',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Bergheim',
  ...
  // Welle 7 (P3-B2c, 17.08.2026) — die 32 fehlenden NRW-Staedte zwischen 40 und
  // 60 Tsd. Einwohnern. Zusammen mit Welle 6 ist NRW ab 40 Tsd. vollstaendig.
  //
  // Gerichtsketten einzeln bei ag-<name>.nrw.de/aufgaben/gerichtsbezirk belegt.
  // Die Zuordnung folgt wieder KEINER Geografie und war auch hier nicht ableitbar:
  //   Erftstadt -> AG Bruehl (nicht Kerpen, obwohl naeher)
  //   Bad Salzuflen -> AG Lemgo -> LG Detmold, das nahe Loehne -> LG Bielefeld
  //   Willich -> AG Krefeld, das benachbarte Kaarst -> AG Neuss
  // 15 der 32 haben KEIN eigenes Amtsgericht — knapp die Haelfte, in dieser
  // Groessenklasse also der Normalfall und nicht die Ausnahme: Stolberg
  // (AG Eschweiler), Erftstadt (AG Bruehl), Meerbusch + Kaarst (AG Neuss),
  // Erkrath (AG Mettmann), Monheim am Rhein (AG Langenfeld), Bergkamen
  // (AG Kamen), Willich (AG Krefeld), Pulheim (AG Bergheim), Frechen
  // (AG Kerpen), Bad Salzuflen (AG Lemgo), Loehne (AG Bad Oeynhausen) sowie
  // Alsdorf + Herzogenrath + Wuerselen (alle AG Aachen).
  //
  // Einwohner: Wikipedia-Liste der Staedte in NRW, Stand 31.12.2025.
  // Koordinaten und PLZ: Mapbox Places (Typ place bzw. postcode).
  // ACHTUNG bei kuenftigen Batches: Mapbox lieferte fuer "Alsdorf Rheinland"
  // das Alsdorf im Kreis Altenkirchen (Rheinland-Pfalz) — plausible Koordinaten,
  // falscher Ort. Die Koordinaten-Invariante faengt das NICHT (auch RLP liegt in
  // Deutschland). Treffer immer gegen place_name pruefen; Mapbox nennt das
  // Bundesland dort ENGLISCH ("North Rhine-Westphalia").
  {
    slug: 'euskirchen',
    name: 'Euskirchen',
    bundesland: 'Nordrhein-Westfalen',
  ...
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Aachen',
      amtsgericht: 'Amtsgericht Eschweiler',
      kammer: 'Rechtsanwaltskammer Köln',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Eschweiler',
  },
  {
  ...
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Arnsberg',
      amtsgericht: 'Amtsgericht Menden',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Menden',
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Münster',
      amtsgericht: 'Amtsgericht Ibbenbüren',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Ibbenbüren',
  },
  {
    slug: 'gummersbach',
    name: 'Gummersbach',
  ...
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Münster',
      amtsgericht: 'Amtsgericht Gronau',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Gronau',
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Münster',
      amtsgericht: 'Amtsgericht Dülmen',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Dülmen',
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Bielefeld',
      amtsgericht: 'Amtsgericht Rheda-Wiedenbrück',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Rheda-Wiedenbrück',
  },
  {
    slug: 'borken',
    name: 'Borken',
    ...
    lokal: {
      landgericht: 'Landgericht Münster',
      amtsgericht: 'Amtsgericht Borken',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Borken',
  ...
  },
  {
    ...
    lokal: {
      landgericht: 'Landgericht Detmold',
      amtsgericht: 'Amtsgericht Lemgo',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Bad Salzuflen',
  },
  {
    slug: 'bad-oeynhausen',
    name: 'Bad Oeynhausen',
    ...
    lokal: {
      landgericht: 'Landgericht Bielefeld',
      amtsgericht: 'Amtsgericht Bad Oeynhausen',
      kammer: 'Rechtsanwaltskammer Hamm',
    },
    bvskHonorarSpanne: '550–2.200 €',
    h1Anker: 'in Bad Oeynhausen',
  },
  {
    slug: 'loehne',
    name: 'Löhne',
...
const HYPERLOCAL_DATA: Record<string, HyperLocal> = {
  ...
  duesseldorf: {
    ...
    // 'Monheim' hiess bis 17.08.2026 nur so — gemeint war immer Monheim am
    // Rhein (Kreis Mettmann, direkter Suednachbar). Solange die Stadt keine
    // Seite hatte, war der Kurzname folgenlos; mit Welle 7 bekam sie eine, und
    // der exakte Namensvergleich haette den Link stillschweigend uebersprungen.
    angrenzendeOrte: ['Neuss', 'Ratingen', 'Meerbusch', 'Erkrath', 'Mettmann', 'Hilden', 'Langenfeld', 'Monheim am Rhein', 'Dormagen', 'Kaarst', 'Korschenbroich'],
    unfallHotspots: [
  ...
  bonn: {
    ...
    lokaleFaqs: [
      ...
      { frage: 'Können Sie auch Oldtimer und Elektrofahrzeuge bewerten?', antwort: 'Ja. Wir erstellen Wertgutachten für Klassiker, Youngtimer und H-Kennzeichen-Anträge sowie Schadens- und Akku-Gutachten für Elektrofahrzeuge (z. B. Tesla, ID-Modelle, e-tron). Je nach Fahrzeug nutzen die Sachverständigen Schwacke, Classic-Data oder classic-analytics.' },
    ],
  },
  hamburg: {
 ...
 * Ziele treffen — 'Bergisch Gladbach' ist nicht 'Gladbach', und ein Ortsteil
 * wie 'Koeln-Ehrenfeld' ist keine Stadt.
 *
 * Der Preis dafuer ist, dass eine ungenaue Schreibweise in angrenzendeOrte den
 * Link still verliert statt zu knallen. Genau das war bis 17.08.2026 bei
 * duesseldorfs 'Monheim' der Fall (gemeint: 'Monheim am Rhein'). Wer eine
 * Stadt neu aufnimmt, prueft deshalb, ob ihr Name irgendwo verkuerzt in einer
 * angrenzendeOrte-Liste steht.
 */
