      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 md:flex-row">
          ...
          <div className="flex items-center gap-4 text-sm text-white/70">
            ...
            {/* ProvenExpert-Profil — reiner Textlink im Footer. Das sichtbare SIEGEL
                (Sterne + Note + Anzahl, LIVE aus api_rating_v2) sitzt im Home-Trust-Strip:
                components/shared/ProvenExpertSiegel.tsx. Hier bewusst nur der Link —
                zwei Siegel auf einer Seite verwaessern das Signal. */}
            <a
