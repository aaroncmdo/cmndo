        ...
        >
          ...
          <div style={{ display: 'flex', gap: 40, marginBottom: 36 }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              <span style={{ fontSize: 36, fontWeight: 800, color: 'white', fontFamily: 'system-ui', lineHeight: 1 }}>100 %</span>
              <span style={{ fontSize: 14, color: '#4573A2', fontFamily: 'system-ui' }}>unabhängige Gutachter</span>
            </div>
