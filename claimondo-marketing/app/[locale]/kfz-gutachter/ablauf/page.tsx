...
const SCHRITTE = [
  ...
  },
  {
    ...
    icon: FileSignature,
    text: 'Kfz-Sachverständiger besichtigt das Fahrzeug – bei Ihnen, in der Werkstatt oder am Arbeitsplatz. Bericht inkl. Reparaturkosten, Wertminderung, Restwert (bei Totalschaden) und Wiederbeschaffungswert. Unsere Partnerkanzlei fordert anschließend von der gegnerischen Versicherung.',
  },
  {
    nr: '04',
    titel: 'Auszahlung',
    ...
    <div className="min-h-screen bg-claimondo-bg">
      <script
        ...
        dangerouslySetInnerHTML={jsonLdScript([
          ...
          faqPageSchema(FAQS, {
            dateModified: getRouteLastUpdatedISO('/kfz-gutachter/ablauf'),
            url: '/kfz-gutachter/ablauf',
          }),
          breadcrumbsSchema([
            { name: 'Startseite', url: '/' },
