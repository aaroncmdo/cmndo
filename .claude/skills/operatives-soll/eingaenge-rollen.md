...
| B-3 | Public-API `POST /api/v1/melde-schaden` (MCP-Tool) | lead-first | Team-WhatsApp über `notify-new-lead.ts` (gemessen 19.09.); FlowLink ohne E-Mail nie zustellbar → #5986 · E-Mail **Pflichtfeld** + Leitungstyp-Weiche seit 21.09. |
