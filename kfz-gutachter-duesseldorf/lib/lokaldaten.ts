// Lokal-Daten-Layer (Duesseldorf-Re-Skin): Struktur aus dem Koeln-Endstand uebernommen.
// Duesseldorf-Spokes nutzen aktuell den `vorort`-Absatz aus SEO_BODY fuer die
// Einsatzgebiet-Lokalstrecke; LOKALDATEN ist hier (noch) leer — sobald gepruefte
// Unfallatlas-Brennpunkte je Duesseldorf-Stadt vorliegen, hier ergaenzen
...
export interface LokalDaten {
  ...
  stadtteile: string[]
  /** Hauptachsen als Fliesstext-Fragment ("A57, A52 und A46"). */
  achsen: string
