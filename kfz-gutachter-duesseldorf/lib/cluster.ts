...
export const SEO_BODY: Record<string, SeoAbsatz[]> = {
  ...
  neuss: [
    ...
    { h3: 'Original, Identteil oder Gebrauchtteil?', text: `Nicht jedes Ersatzteil ist gleichwertig. Originalteile kommen vom Fahrzeughersteller, Identteile stammen vom selben Zulieferer ohne Herstellerlogo, dazu kommen Nachbauteile freier Anbieter und Gebrauchtteile. Welche Qualität angesetzt werden darf, hängt vom Alter des Fahrzeugs ab, von seiner Wartungshistorie und davon, ob das Bauteil sicherheitsrelevant ist. Bei jungen Fahrzeugen und bei Teilen der Karosseriestruktur sind Originalteile der Maßstab, bei einem älteren Kotflügel kann ein Identteil genügen. Wir schreiben in die Kalkulation, welche Qualität wir angesetzt haben und warum — sonst wird sie später stillschweigend gegen die günstigere getauscht, und der Unterschied fällt erst beim Einbau auf.` },
  ...
  hilden: [
    ...
    { h3: 'Darf ein Stoßfänger repariert werden?', text: `Manchmal ja, oft nein — und die Grenze verläuft nicht dort, wo man sie vermutet. Eine Kunststoffreparatur ist bei oberflächlichen Schrammen und kleineren Rissen möglich, wenn der Werkstoff sich schweißen oder strukturell kleben lässt und die Verformung sich zurückstellt. Ausgeschlossen ist sie bei Rissen an Befestigungspunkten, bei Weißbruch über größere Flächen und überall dort, wo Sensorhalter oder der Prallkörper dahinter betroffen sind. Auch die Materialsorte entscheidet mit: Nicht jeder Kunststoff nimmt eine Reparatur an, und die Kennzeichnung dazu steht auf der Innenseite des Bauteils. Wir sehen dort nach, bevor wir Ersatz kalkulieren — und ebenso, bevor wir eine Reparatur ansetzen, die später nicht hält.` },
  ...
  erkrath: [
    ...
    { h3: 'Warum gehört eine Funktionsprüfung zur Begutachtung?', text: `Weil manche Schäden sich nur im Fahrbetrieb zeigen. Ein Fahrzeug, das nach einem Anstoß leicht zur Seite zieht, dessen Lenkrad nicht mehr gerade steht oder das beim Bremsen ein neues Geräusch macht, hat mit hoher Wahrscheinlichkeit etwas am Fahrwerk abbekommen — zu sehen ist davon oft nichts. Dasselbe gilt für Türen und Klappen, die nach einem Seitenschaden schwerer schließen, für Fensterheber, die plötzlich haken, und für Geräusche aus dem Radhaus. Wir fragen deshalb immer, wie sich das Auto seit dem Unfall anfühlt, und nehmen diese Beobachtungen mit ins Gutachten. Sie sind der Anlass für die gezielte Prüfung, die sonst niemand veranlasst — und im Streitfall der Beleg dafür, dass der Schaden von Anfang an vorhanden war.` },
  ...
  langenfeld: [
    ...
    { h3: 'Woran erkennen Sie einen qualifizierten Sachverständigen?', text: `Die Berufsbezeichnung allein sagt wenig — sie ist nicht geschützt. Deshalb lohnt der Blick auf drei Dinge. Erstens die Qualifikation: eine Ausbildung im Kfz-Handwerk oder ein technisches Studium, dazu eine Zertifizierung oder öffentliche Bestellung, die regelmäßig überprüft wird. Zweitens die Unabhängigkeit: Wer einer Werkstatt oder einer Versicherung gehört, hat ein Interesse am Ergebnis, und sei es nur am Reparaturauftrag. Drittens die Ausstattung — Schichtdickenmessgerät, ein Kalkulationssystem mit Herstellerdaten und Zugang zu Marktdatenbanken für Wiederbeschaffungs- und Restwert sind Grundausstattung, nicht Sonderausstattung. Fragen Sie ruhig danach, bevor Sie beauftragen. Ein seriöser Gutachter erklärt Ihnen vorab, was er tut, wie lange es dauert und wer die Kosten trägt — und er sagt Ihnen auch, wenn sich ein Gutachten in Ihrem Fall nicht lohnt.` },
  ...
  monheim: [
    ...
    { h3: 'Welche Angaben sollten Sie am Unfallort sichern?', text: `Mehr als das Kennzeichen. Notieren Sie Name und Anschrift des Fahrers, den Halter, falls er nicht selbst gefahren ist, die Versicherung samt Versicherungsscheinnummer und die Kontaktdaten von Zeugen — Letztere sind später fast nie mehr auffindbar. Fotografieren Sie beide Fahrzeuge in der Endstellung, den Schaden aus mehreren Abständen, die Umgebung mit Beschilderung und Fahrbahnmarkierung sowie die Kennzeichen. Bei einem Firmenfahrzeug gehört der Firmenname dazu, weil die Regulierung dann über eine Flottenpolice laufen kann und der Ansprechpartner ein anderer ist. Was Sie nicht tun sollten: am Unfallort ein Schuldanerkenntnis abgeben oder etwas unterschreiben, dessen Inhalt Sie nicht vollständig gelesen haben.` },
  ...
  ratingen: [
    ...
    { h3: 'Was passiert nach dem Gutachten?', text: `Es geht an Sie und, wenn Sie es wünschen, direkt an die gegnerische Versicherung und an Ihre Kanzlei. Dort landet es in aller Regel zunächst bei einem beauftragten Prüfdienstleister, der die Kalkulation Position für Position durchgeht und Kürzungsvorschläge macht — das ist Routine und noch kein Streit. Danach folgt entweder die Zahlung oder ein Kürzungsschreiben mit Begründung. Wird gezahlt, ist es häufig zuerst nur der unstrittige Teil; achten Sie deshalb darauf, welche Positionen tatsächlich beglichen wurden, statt nur auf den Gesamtbetrag zu sehen. Bleibt etwas offen, prüfen wir die Begründung fachlich und liefern die Stellungnahme, mit der ein Verkehrsrechtsanwalt nachfassen kann. Ohne Widerspruch wird aus einer Kürzung schnell ein akzeptierter Endstand.` },
  ...
  meerbusch: [
    ...
    { h3: 'Motorrad, Wohnmobil, Anhänger — gilt das Gleiche?', text: `Im Grundsatz ja, in der Ausführung nicht. Beim Motorrad entscheidet die Rahmengeometrie: Ein verzogener Rahmen oder eine verbogene Gabelbrücke bedeutet fast immer wirtschaftlichen Totalschaden, und Anbauteile wie Verkleidung, Koffersatz und Auspuffanlage machen einen ungewöhnlich hohen Anteil am Fahrzeugwert aus. Bei Wohnmobil und Wohnwagen kommt der Aufbau hinzu — dort ist nicht das verbeulte Blech das eigentliche Problem, sondern die Dichtigkeit: Eine beschädigte Außenhaut lässt Feuchtigkeit in die Sandwichstruktur, und der Folgeschaden zeigt sich erst Monate später als weiche Wand. Bei Anhängern zählen Zugdeichsel, Auflaufeinrichtung und Rahmen, dazu die Frage, ob nach dem Schaden überhaupt noch eine Zulassung möglich ist. Für alle drei gilt: Die Wertermittlung ist aufwendiger als beim Pkw, weil es weniger Vergleichsangebote am Markt gibt.` },
  ...
  grevenbroich: [
    ...
    { h3: 'Hagelschaden — warum das eine eigene Aufnahme ist', text: `Ein Hagelschaden wird nicht kalkuliert wie ein Anstoß, sondern gezählt. Erfasst werden Anzahl und Größe der Dellen je Bauteil, dazu ihre Lage: Dach, Motorhaube und Kofferraumdeckel trifft es fast immer stärker als die Flanken. Daraus ergibt sich, ob die Dellen ohne Lackierung von innen ausgedrückt werden können oder ob das Blech ersetzt werden muss — entscheidend sind Dellentiefe, die Nähe zu Kanten und Sicken sowie die Zugänglichkeit von der Rückseite. Aluminiumteile verhalten sich dabei anders als Stahl und lassen sich seltener drücken. Reguliert wird über die Teilkasko; es gibt also keinen Verursacher und keine gegnerische Versicherung, die das Honorar trägt. Auch diese Kostenfrage klären wir vorab, damit Sie wissen, woran Sie sind, bevor etwas beauftragt wird.` },
