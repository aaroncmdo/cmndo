...
//
// Uebernommen aus den Cluster-Landingpages (kfz-gutachter-*), damit alle
// Claimondo-Auftritte dasselbe Siegel mit derselben Konfiguration zeigen.
//
// KEIN CONSENT-GATE — Entscheidung Aaron 13.08.2026, gleich wie auf claimondo.de.
// Das Siegel laedt auf jedem Seitenaufruf. Es haengt damit an KEINER
// Consent-Kategorie; ein Schalter, der etwas zu steuern vorgibt, das er nicht
...
//
// ⚠ RECHTSGRUNDLAGE: Abschnitt 9.6 der Datenschutzerklaerung auf
// claimondo.de/datenschutz. Diese Seite verlinkt sie im Fuss — bis 24.08. tat
// sie das NICHT, und ohne den Verweis waere die Uebermittlung an einen Dritten
// nirgends dokumentiert gewesen.
//
// ⚠ Wer das wieder an eine Einwilligung haengen will, muss BEIDES anfassen:
// dieses Gate und den Rechtstext in 9.6.
//
