// Zentrale Site-Konfiguration · Kfz-Gutachter Bonn (Cluster-Master).
...
export const SITE = {
  name: 'Kfz-Gutachter Bonn',
  shortName: 'Kfz-Gutachter Bonn',
  url: process.env.NEXT_PUBLIC_SITE_URL ?? 'https://kfz-unfallgutachter-bonn.de',
  locale: 'de_DE',
  lang: 'de',
