-- Fix zu 20260603213320: phone als Dedup-Signal entfernt. Live-Verify zeigte 53/76
-- personen teilen die Embed/Baileys-Zielnummer +491633628571 (+ Test-/Platzhalter-
-- nummern) => phone-allein explodiert zu Falsch-Paaren (200+ gecapped). phone ist ein
-- KORROBORIERENDES Signal (match_person_candidates wertet typed_phone nur 15), kein
-- Dedup-Schluessel. email + nachname+geburtsdatum sind die verlaesslichen Signale
-- (finden aktuell 0 = ehrlicher Ist-Zustand: keine Dubletten). Falls phone-Dedup spaeter
-- gewuenscht: System-/Platzhalternummern erst ausschliessen (eigene Erweiterung).
