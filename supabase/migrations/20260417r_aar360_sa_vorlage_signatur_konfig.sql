...
COMMENT ON COLUMN sachverstaendige.sa_vorlage_signatur_konfig IS
  'AAR-360: Position-Konfig für SA-Tool-PDF-Merge (Kunden-Unterschrift + Datum + Name auf Gutachter-SA-Vorlage). NULL => Default-Position (unten links). Admin-UI-Editor folgt nach MVP.';
