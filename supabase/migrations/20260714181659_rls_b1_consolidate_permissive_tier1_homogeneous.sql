...
CREATE TEMP TABLE _b1_orig ON COMMIT DROP AS
  ...
  FROM pg_policies
  WHERE schemaname='public' AND permissive='PERMISSIVE' AND tablename = ANY(ARRAY['airdrop_invitations','auftraege','benachrichtigungen','claim_mietwagen','claim_vehicle_involvements','communities','community_leaderboard','community_memberships','dokument_katalog','embed_abrechnung_positionen','embed_sites','firmen_flotten_konten','flotten_fahrzeuge','gutachten','gutachten_fotos','gutachter_abrechnungspositionen','gutachter_monatsabrechnungen','gutschriften','incentive_auszahlungen','incentives','kanzlei_abrechnung_positionen','kanzlei_abrechnungen','kanzlei_faelle','kanzlei_pakete','kanzleien','ki_gespraeche','kunde_live_position','leadpreise_tabelle','makler','makler_fall_consent','makler_staffel_stufen','maklerpools','mitarbeiter_performance','ocr_runs','organisationen','parteien','partner_gutschriften','partner_provisionen','partner_rollen_policy','partner_staffel_bonus','promo_clicks','promotion_codes','reklamationen','schadenkarten','schadenspositionen','sv_buero','sv_buero_memberships','sv_kalender_verbindungen','sv_leads','sv_tages_session','tasks','termine','vehicle_ownership_history','vehicle_vorschaeden','versicherungen','vertraege_unterzeichnet','vertragsvorlagen','werkstaetten','werkstatt_staffel_stufen']);
...
DO $b1$
DECLARE
  v_tables text[] := ARRAY['airdrop_invitations','auftraege','benachrichtigungen','claim_mietwagen','claim_vehicle_involvements','communities','community_leaderboard','community_memberships','dokument_katalog','embed_abrechnung_positionen','embed_sites','firmen_flotten_konten','flotten_fahrzeuge','gutachten','gutachten_fotos','gutachter_abrechnungspositionen','gutachter_monatsabrechnungen','gutschriften','incentive_auszahlungen','incentives','kanzlei_abrechnung_positionen','kanzlei_abrechnungen','kanzlei_faelle','kanzlei_pakete','kanzleien','ki_gespraeche','kunde_live_position','leadpreise_tabelle','makler','makler_fall_consent','makler_staffel_stufen','maklerpools','mitarbeiter_performance','ocr_runs','organisationen','parteien','partner_gutschriften','partner_provisionen','partner_rollen_policy','partner_staffel_bonus','promo_clicks','promotion_codes','reklamationen','schadenkarten','schadenspositionen','sv_buero','sv_buero_memberships','sv_kalender_verbindungen','sv_leads','sv_tages_session','tasks','termine','vehicle_ownership_history','vehicle_vorschaeden','versicherungen','vertraege_unterzeichnet','vertragsvorlagen','werkstaetten','werkstatt_staffel_stufen'];
...
BEGIN
  ...
  SELECT string_agg(tablename||'/'||rl||'/'||cx, ', ') INTO v_bad FROM (
    ...
    WHERE p.schemaname='public' AND p.tablename = ANY(ARRAY['airdrop_invitations','auftraege','benachrichtigungen','claim_mietwagen','claim_vehicle_involvements','communities','community_leaderboard','community_memberships','dokument_katalog','embed_abrechnung_positionen','embed_sites','firmen_flotten_konten','flotten_fahrzeuge','gutachten','gutachten_fotos','gutachter_abrechnungspositionen','gutachter_monatsabrechnungen','gutschriften','incentive_auszahlungen','incentives','kanzlei_abrechnung_positionen','kanzlei_abrechnungen','kanzlei_faelle','kanzlei_pakete','kanzleien','ki_gespraeche','kunde_live_position','leadpreise_tabelle','makler','makler_fall_consent','makler_staffel_stufen','maklerpools','mitarbeiter_performance','ocr_runs','organisationen','parteien','partner_gutschriften','partner_provisionen','partner_rollen_policy','partner_staffel_bonus','promo_clicks','promotion_codes','reklamationen','schadenkarten','schadenspositionen','sv_buero','sv_buero_memberships','sv_kalender_verbindungen','sv_leads','sv_tages_session','tasks','termine','vehicle_ownership_history','vehicle_vorschaeden','versicherungen','vertraege_unterzeichnet','vertragsvorlagen','werkstaetten','werkstatt_staffel_stufen']) AND p.permissive='PERMISSIVE' AND rl IN ('anon','authenticated')
