-- Phase 2b: v_partner_billing liest die 4 Provisions-/Bonus-Branches jetzt aus
-- partner_provisionen / partner_staffel_bonus (typ-gefiltert) statt der 4 Alt-Tabellen.
-- Die 4 anderen Branches (abrechnungen-sv / kanzlei / onboarding / provisionen_maik) UNVERAENDERT.
-- Output-Signatur Before==After (20 Spalten identisch), Provisions-Daten identisch (9 rows, 1250.00
-- netto) -- prod-verifiziert. quelle_tabelle kollabiert makler/werkstatt -> 'partner_provisionen'
-- (bzw. '*_staffel_bonus'); quelle_id (row-id) bleibt global eindeutig -> Action/Gutschrift-Lookup ok.
