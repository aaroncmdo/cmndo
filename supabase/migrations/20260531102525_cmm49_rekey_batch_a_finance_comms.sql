-- CMM-49 FK-Re-Key Batch A — Finanz + Comms-Logs (15 Tische, kollisionsfrei).
-- Pro Tisch: claim_id ADD + Backfill aus faelle + Index + FK auf claims (on_delete
-- gespiegelt) + Ableitungs-Trigger. Additiv, idempotent. fall_id bleibt unangetastet.
DO $$
DECLARE
  pairs text[][] := ARRAY[
