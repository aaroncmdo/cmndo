-- Additiv: rueckruf_wunschzeit (Kunde-Rueckrufbitte) in v_werkstatt_auftrag durchreichen.
-- Definition 1:1 uebernommen; neue Spalte am ENDE (CREATE OR REPLACE VIEW erlaubt nur Anhaengen).
-- WHERE-Gate (is_staff() OR is_werkstatt_for_claim) unveraendert; audit_ungated_definer_views()=0 verifiziert.
