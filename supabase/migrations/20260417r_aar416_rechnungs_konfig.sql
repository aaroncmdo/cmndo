-- AAR-416: Rechnungs-Harmonisierung — gemeinsame Stammdaten-Tabelle für
-- Setup-Anzahlung (CM-ONB-) und spätere Monatsabrechnung (CMNDO-).
-- Versioniert über gueltig_ab/gueltig_bis — bei GmbH-Gründung neue Zeile
-- einfügen, alte schließen.
--
-- Korrigierte IBAN (17.04.2026): DE45 1001 1001 2844 4649 31 (N26,
-- Kontoinhaber Nicolas Kitta). Treuhand für Claimondo GmbH i.Gr.
...
-- Seed: GmbH i.Gr. + GbR-Treuhand mit korrigierter N26-IBAN und
-- ausgeschriebenen Geschäftsführer-Namen.
INSERT INTO rechnungs_konfiguration (
  ...
  '50670',
  'Köln',
  NULL, -- TODO: nach GmbH-Gründung setzen (AAR-407)
  NULL, -- TODO: USt-IdNr. nach GmbH-Gründung (AAR-407)
  NULL, -- TODO: HRB-Nr. nach GmbH-Gründung (AAR-407)
...
-- Archiv-Tabelle für Setup-Anzahlungs-Rechnungen (Serie CM-ONB-YYYY-NNNNN)
...
-- Counter-Tabelle für atomare fortlaufende Rechnungs-Nr. pro Jahr.
-- Alternative zu SEQUENCE (erlaubt Jahres-Reset ohne Sequence-DDL).
...
-- Atomarer Counter: SELECT ... FOR UPDATE via UPSERT + RETURNING.
-- Nutzung: SELECT next_rechnungs_nr('CM-ONB', 2026);
