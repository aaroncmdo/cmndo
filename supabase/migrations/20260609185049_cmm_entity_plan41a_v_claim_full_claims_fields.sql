-- CMM-Entity Plan 4.1a: 4 claims-native Felder additiv in v_claim_full (CMM-49-Ask #1).
-- notizen/zeugen_kontakte/kunde_email/vorsteuerabzugsberechtigt -> entsperrt lexdrive + feldmodus/_fallakte-Repoints.
-- Rein additiv -> CREATE OR REPLACE (Grants/anon-Revoke bleiben erhalten, kein DROP). baujahr-int-Fix = separat (Type-Change braucht DROP+recreate).
