-- CMM-44 SP-I3 PR1 -- Regulierung/VS (14 Spalten) faelle -> kanzlei_faelle, additiv (kein DROP).
...
CREATE OR REPLACE VIEW public.v_faelle_mit_aktuellem_termin AS  SELECT f.id,
    ...
    kf.kuerzungs_betrag::numeric(10,2) AS kuerzungs_betrag,
    kf.vs_frist_bis,
    f.ruege_counter,
    ...
    f.halter_name,
    t.wunschtermin,
    kf.vs_quote_prozent::numeric(5,2) AS vs_quote_prozent,
    kf.vs_quote_grund,
    kf.vs_quote_akzeptiert_am,
    kf.vs_quote_betrag_ausgezahlt::numeric(10,2) AS vs_quote_betrag_ausgezahlt,
    kf.vs_kuerzungs_typ,
