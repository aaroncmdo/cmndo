...
--   → Kein Backfill nötig.
--
-- Code-Sweep: nur lexdrive/email-sender.ts referenzierte zeuge_* — auf
-- Array-Iteration über zeugen_kontakte migriert im gleichen Commit.
-- Alle anderen Consumer (Phase4Stammdaten, schaden-melden, update-lead-gegner,
-- lead-fall-mapping, pflicht-dokumente, makler/queries) nutzen bereits
-- ausschließlich zeugen_kontakte.
