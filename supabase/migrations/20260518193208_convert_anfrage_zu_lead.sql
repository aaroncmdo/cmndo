...
-- Idempotenz, Exception-Handler versucht best-effort konvertier_status='failed'
-- zu persistieren (aber plpgsql-Subtransaction rollt bei autocommit-RPC-Caller
-- zurück — Caller-side-Logging ist die verlässliche Failure-Trace).
-- Channel-spezifische Side-Effects in IF-Blöcken (aktuell alle auskommentiert).
--
