-- CMM-44 SP-J PR1 (Bucket B) — 8 ADD auf claims + Backfill + 3 View-Repoints
...
-- Repoint v_faelle_mit_aktuellem_termin: 11 Stelle(n) f.-> c./NULL (je genau 1x asserted)
...
-- Repoint faelle_kunde_view: 1 Stelle(n) f.-> c./NULL (je genau 1x asserted)
...
-- Repoint faelle_sv_view: 1 Stelle(n) f.-> c./NULL (je genau 1x asserted)
