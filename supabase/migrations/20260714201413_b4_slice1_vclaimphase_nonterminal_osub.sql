-- B4-Slice-1: v_claim_phase o_sub behandelt die Non-Terminal-Outcomes in_kommunikation_vs
-- + abgelehnt direkt in operative_status (Vorbereitung fuer den endzustand-Write-Flip).
-- Nur 2 additive Ergaenzungen im o_sub-CASE: 'in_kommunikation_vs' -> versicherungskontakt-Gruppe,
-- 'abgelehnt' -> nachforderung-Gruppe. Provably No-Op bis operative_status diese Werte traegt.
