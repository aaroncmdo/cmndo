-- CMM-47 Cluster B-Rest (2026-05-15) — v_claim_full um 5 weitere faelle-Workflow-Spalten
--
-- Für 3 Mitarbeiter-Portal-Pages (mitarbeiter/page.tsx, mitarbeiter/faelle,
-- mitarbeiter/reklamationen):
--   kennzeichen, fahrzeug_hersteller, fahrzeug_modell, fahrzeug_typ, sa_unterschrieben
--
-- Pre-Check via information_schema.columns 2026-05-15: alle 5 Spalten existieren
-- in faelle, KEINE in claims (workflow-only). Lesson aus Memory
...
SELECT
  ...
  -- CMM-47 A.3 zusätzliche Workflow-Spalten (Migration 20260515095400)
  ...
  -- CMM-47 B-Rest Fahrzeug + Kennzeichen + SA
