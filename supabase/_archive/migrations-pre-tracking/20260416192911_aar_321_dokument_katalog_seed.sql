-- AAR-321 Seed: 24 Slot-Definitionen mit JSON-Rule-DSL.
-- Rule-Format: { "op": "eq"|"in"|"and"|"or", "field": "lead.col" | "fall.col", "value": ... }
-- NULL = keine Einschränkung (immer freigeschaltet / nie Pflicht).
