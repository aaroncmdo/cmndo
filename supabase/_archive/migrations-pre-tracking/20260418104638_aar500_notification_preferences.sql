-- AAR-500 N5: Per-User Benachrichtigungs-Praeferenzen. Quiet-Hours (TIME mit
...
-- mit status='skipped' + skip_reason fuer Audit.
...
COMMENT ON TABLE notification_preferences IS
  'AAR-500 N5: Per-User Benachrichtigungs-Praeferenzen. channel_opt_outs: string[] ("whatsapp","email","web_push","in_app"). event_opt_outs: Record<eventType, channel[]>. urgent-priority-Events umgehen Quiet-Hours.';
