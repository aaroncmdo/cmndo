...
CREATE TABLE IF NOT EXISTS personenschaden_personen (
  ...
  -- Entweder lead_id oder fall_id muss gesetzt sein (im Lead-Phase lead_id,
  -- nach SA zusätzlich fall_id — Row wird bei Fall-Anlegen upgegradet).
...
-- pflichtdokumente: optionaler FK auf Person, damit Attest/AU/Krankenhaus
-- einer konkreten verletzten Person zugeordnet werden können.
...
-- Policy 1: Dispatch/Admin können alles
...
-- Policy 2: Kunde kann Personen zu seinem Fall sehen + bearbeiten
