...
-- Daten-Check: alle 14 Rows haben Default 'nicht-noetig' — keine Daten.
-- Code-Check: 0 Consumer ausser database.types.ts.
-- Anwalt-Lifecycle wird durch kanzlei_id / kanzlei_uebergeben_am /
-- kanzlei_provision_status abgebildet — anwalt_status war totes Feld.
