...
-- Rebuild v_faelle_mit_aktuellem_termin als Compat-Shim + DROP COLUMN x6.

-- 1. View drop+recreate (wegen geaenderter Spaltenliste)
...
COMMENT ON VIEW v_faelle_mit_aktuellem_termin IS
  ...
  'dann start_zeit DESC. Spiegelt die 5 gedroppten faelle-Legacy-Felder aus termine.';;
