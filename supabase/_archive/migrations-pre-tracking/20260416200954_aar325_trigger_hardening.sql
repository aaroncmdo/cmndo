-- AAR-325 Audit-Fix: SET search_path im SECURITY-DEFINER-Trigger (Schema-Hijacking-Schutz)
-- + Index auf tasks(entity_type, entity_id) für Dedup-Query-Performance.
...
CREATE INDEX IF NOT EXISTS idx_tasks_entity ON public.tasks(entity_type, entity_id) WHERE entity_type IS NOT NULL;;
