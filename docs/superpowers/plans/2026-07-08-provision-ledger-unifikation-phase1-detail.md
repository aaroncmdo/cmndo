...
**Gekoppelte Hälfte:** `docs/superpowers/plans/2026-07-08-provision-ledger-unifikation-phase2-detail.md` (Reader/View). **Phase 1 (Schreib-Seite) und Phase 2 (Lese-Seite) deployen ZUSAMMEN** — ein kombinierter PR gegen `staging`, nie eine Hälfte allein nach `main`. Phase 1 allein → neue Rows unsichtbar/unauszahlbar; Phase 2 allein → View liest leere Union-Tabelle. Details im Kopplungs-Abschnitt §1 unten.
