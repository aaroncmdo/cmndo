...
Das ist **kein Widerspruch zum Code**, sondern die Bestätigung der Rest-Tranche: #5252 hat die obere Ebene (`sendFallCommunication`) durable gemacht, die 645 laufen über die untere (`sendCommunication`). Solange die nicht migriert ist, deckt die Outbox real **~0,3 %** ab.
