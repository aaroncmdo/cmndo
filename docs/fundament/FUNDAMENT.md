...
| B3 | Journey-Suite J2–J10 in CI (§9-P2) | B1, B2 | 🟡 **in Arbeit — alle Skips → CI-Steps** (Aaron-Direktive 04.08. „keine Skips"; §9-P2 erst erfüllt, wenn alle 10 wirklich CI-grün laufen — die 03.08.-„§9 via Skips"-Deklaration ist revidiert). **ALLE 10 Journeys code-komplett als CI-Step** (04.–05.08.): J1, J4 (B2) + **J9** (#4948) + **J8** (#4955) + **J5** + **J10** + **J3** + **J6** + **J7** (inkl. Prod-Fix der schema-gedrifteten `dsgvo_anonymize_user_data`-RPC Migration `20260804193646`) + **J2** (3 Meldewege: Kunde-Wizard/API/Gegner-Schadenkarte, inkl. Dedup-Idempotenz-Beweis; alle lokal prod-grün, J2 Smoke 3/3 + Assert 11/11). **Grün-NACHWEIS in CI** = erster post-merge-`e2e`-Lauf nach Merge der PR-Kette → dann §9-P2 erfüllt. **J9-`lifecycle` seit 05.08. ebenfalls im CI-Step** (Aaron-Entscheid: Fremd-Effekt-Precheck-Geld-Guard im Spec statt Produkt-Change am Release-Runner) — Suite ohne Rest vollständig. Klassifikation + Reihenfolge: `journey-smokes.md` + DECISIONS 04./05.08. | #4948/#4955 + J5/J10/J3/J6/J7/J2 |
