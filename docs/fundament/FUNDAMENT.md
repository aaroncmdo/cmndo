...
| B3 | Journey-Suite J2–J10 in CI (§9-P2) | B1, B2 | 🟡 **in Arbeit — alle Skips → CI-Steps** (Aaron-Direktive 04.08. „keine Skips"; §9-P2 erst erfüllt, wenn alle 10 wirklich CI-grün laufen — die 03.08.-„§9 via Skips"-Deklaration ist revidiert). **Grün in CI:** J1, J4 (B2) + **J9** (#4948) + **J8** (#4955) + **J5** + **J10** + **J3** + **J6** (04.08.: deterministische Wegwerf-Seeds — J5 kasko aal1; J10 werkstatt-finder S1+S3 (S2-`test.skip`); J3 SA-Signatur anon `/flow/[token]` Canvas; J6 Kanzlei-Übergabe Kunde-Login „Kanzleipaket versenden"; alle lokal grün). **Im Bau (Skip → CI-Step):** J7 (Skeleton → echte Logik), J2 (Multi-Kanal), J9-`lifecycle` (Release-Cron Test-Row-Isolation, ggf. Produkt-Change). Klassifikation + Reihenfolge: `journey-smokes.md` + DECISIONS 04.08. | #4948/#4955 + J5/J10/J3/J6 |
