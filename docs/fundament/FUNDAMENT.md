...
| B3 | Journey-Suite J2–J10 in CI (§9-P2) | B1, B2 | 🟢 **CI-Kern done — §9-Punkt-2 erfüllt** (8c6de199, 03.08.). **Grün in CI:** J1, J4 (B2) + **J9** (#4948) + **J8** (#4955). **Begründet+journey-referenziert geskippt** (§9-konform): J2/J3/J6 (echte Buchung/nur eingebettet, Signatur-Mechanik via J4), J7 (Skeleton/DSGVO irreversibel), J9-`lifecycle` (globaler Release-Cron = Geld-Timing), **J5** (Fixture-Claim gedriftet), **J10** (Flow-Wizard-Fragilität + prod-Mutation). Volle Klassifikation: `journey-smokes.md`. Optionale Follow-ups: deterministische Seeds für J5 + J10-Szenario-1 | #4948 + #4955 |
