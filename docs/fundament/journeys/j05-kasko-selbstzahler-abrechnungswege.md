...
**Eingang Teilkasko + Glas (Kasko-WB, 05.09.2026):** Ein Ereignis ohne Unfallgegner (Hagel, Sturm, Marder, Wild, Glas, Diebstahl) ist **genauso werkstattgebunden wie ein Unfall** — die Wissensbasis sagt bei nahezu jeder Kondition „Vollkasko und Teilkasko inkl. Glas". Die Schuldfrage bietet dafür eine vierte Antwort „Kein Gegner beteiligt"; sie führt in denselben Kasko-Zweig wie „Ich selbst" (gespeicherter Wert unverändert `eigenverantwortung`, die Unterscheidung trägt `leads.schadentyp`). Die Schadenart kennt jetzt auch die Ereignisse ohne Gegner (Migration `20260905185823` für den CHECK, `20260905185921` für die Auswahl). **Glas:** `schadentyp='glas'` gilt als Glasschaden — erst dadurch greifen die neun Tarife, die NUR Glas binden (KRAVAG, Signal Iduna, VÖDAG); bei jeder anderen Schadenart bleibt der Kunde bei einer reinen Glas-Bindung frei (E7, Aaron 04.09.). Gilt im FlowLink und im Kunden-Portal; die Berater-API nimmt den Glas-Fall als Parameter. Vorher lief die Ableitung an sieben Stellen fest auf „Karosserie".
