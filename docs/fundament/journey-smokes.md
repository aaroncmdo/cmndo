...
**Stand — 04.08. (Aaron-Direktive „keine Skips"):** §9-Punkt-2 gilt erst als **erfüllt, wenn alle 10 Journeys wirklich CI-grün** laufen — ein begründeter Skip ist nicht länger das Ziel (die frühere „§9 via Skips erfüllt"-Deklaration war voreilig). **Grün in CI = J1/J4/J9/J8/J5/J10** (J5+J10 neu 04.08.: deterministische Wegwerf-Seeds, lokal grün — J5 kasko aal1-Login, J10 werkstatt-finder S1+S3 mit begründetem S2-`test.skip`). **Im Bau (Skip → CI-Step):** J3 (dedizierter SA/Vollmacht-Seed+Spec), J6 (Kanzlei-Übergabe-Seed+Spec), J7 (Skeleton → echte Storno/DSGVO-Logik über Wegwerf-Konto), J2 (Multi-Kanal-Meldeweg-Seed mit Send-Isolation), J9-`lifecycle` (Release-Cron Test-Row-Isolation — ggf. Produkt-Change, mit Aaron abzustimmen).
