...
**Stand — 04.08. (Aaron-Direktive „keine Skips"):** §9-Punkt-2 gilt erst als **erfüllt, wenn alle 10 Journeys wirklich CI-grün** laufen — ein begründeter Skip ist nicht länger das Ziel (die frühere „§9 via Skips erfüllt"-Deklaration war voreilig). **Grün in CI = J1/J4/J9/J8/J5/J10/J3/J6** (04.08.: deterministische Wegwerf-Seeds, lokal grün — J5 kasko aal1-Login, J10 werkstatt-finder S1+S3 (S2-`test.skip`), J3 SA-Signatur anon `/flow/[token]` Canvas, J6 Kanzlei-Übergabe Kunde-Login „Kanzleipaket versenden"). **Im Bau (Skip → CI-Step):** J7 (Skeleton → echte Storno/DSGVO-Logik über Wegwerf-Konto), J2 (Multi-Kanal-Meldeweg-Seed mit Send-Isolation), J9-`lifecycle` (Release-Cron Test-Row-Isolation — ggf. Produkt-Change, mit Aaron abzustimmen).
