...
**⏰ WANN der Wächter läuft (seit 11.08.):** Der `e2e`-Job läuft **nightly (03:30 UTC) + on-demand (`workflow_dispatch`)**, nicht mehr bei jedem Push — er kam bei der Fleet-Frequenz sonst nie durch (37 Läufe: 21 cancelled, 10 failure, **0 success**; Queue-Verdrängung, nicht Rot). Begründung + verworfene Alternativen: DECISIONS 11.08. Sofort-Beweis nach einem Journey-PR: `gh workflow run CI --ref main`.
