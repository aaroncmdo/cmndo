# Journey-Smoke 2026-05-08T22-22-38
...
- ✅ **PASS:** Lead in DB angelegt: 65a24d63-f2c6-4e9c-b494-9e811ec9b0c5 (status=quali-offen) _(db-lead)_
...
- ✅ **PASS:** Lead-Detail geöffnet: http://localhost:3000/dispatch/leads/65a24d63-f2c6-4e9c-b494-9e811ec9b0c5 _(navigation)_
...
## Phase 3 — PASS:167 SOFT:7 HARD:0

- ℹ️ **INFO:** Button-Audit "admin/admin": 26 klickbare Elemente gefunden (max 25) _(audit-inventory)_
...
- ✅ **PASS:** Button "Neuer Fall 2026-0001gerade eben" → NAV — → /faelle/01b34331-8fb6-4fac-ae61-e73d37361f6e _(btn-nav)_
...
- ✅ **PASS:** Button "Kanzlei-Board" → NAV — → /admin/faelle/kanzlei _(btn-nav)_
...
- ✅ **PASS:** Button "2026-0001" → NAV — → /faelle/01b34331-8fb6-4fac-ae61-e73d37361f6e _(btn-nav)_
- ✅ **PASS:** Button "button#24" → MODAL — Pop-Over/Modal geöffnet _(btn-modal)_
- ✅ **PASS:** Button "Lisa Mueller" → NAV — → /faelle/01b34331-8fb6-4fac-ae61-e73d37361f6e _(btn-nav)_
- ✅ **PASS:** Button "Karte verschieben" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit-Cap erreicht (25) — 26 Elemente nicht getestet _(audit-cap)_
- ℹ️ **INFO:** Audit "admin/admin/faelle" Summary: NAV=15 MODAL=1 NOOP=8 ERROR=0 _(audit-summary)_
...
- ℹ️ **INFO:** Audit übersprungen (destruktiv): "Abmelden" _(audit-skip-danger)_
- ✅ **PASS:** Button "4Neue Leads heute" → NAV — → /dispatch/leads _(btn-nav)_
- ✅ **PASS:** Button "0Offene Rückrufe" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "4FlowLinks versendet" → NAV — → /dispatch/leads _(btn-nav)_
- ✅ **PASS:** Button "Alle anzeigen" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "Alle anzeigen" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung3m" → NAV — → /dispatch/leads/65a24d63-f2c6-4e9c-b494-9e811ec9b0c5 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung10m" → NAV — → /dispatch/leads/bc7319b4-1501-40fa-9bf6-f500f7cbde3c _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung17m" → NAV — → /dispatch/leads/d866026b-6f36-4dc5-8fa6-a2f601fd36c3 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung25m" → NAV — → /dispatch/leads/47e842d2-d7c7-46af-b9ab-716502d2c911 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung42m" → NAV — → /dispatch/leads/0da75f14-077b-4bb2-a9ea-9ecee7ba3a31 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung1h" → NAV — → /dispatch/leads/a2f29757-d6eb-4648-b9eb-1f8d2c986fb2 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung1h" → NAV — → /dispatch/leads/a2f29757-d6eb-4648-b9eb-1f8d2c986fb2 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung1h" → NAV — → /dispatch/leads/a2f29757-d6eb-4648-b9eb-1f8d2c986fb2 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung1h" → NAV — → /dispatch/leads/a2f29757-d6eb-4648-b9eb-1f8d2c986fb2 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung1h" → NAV — → /dispatch/leads/a2f29757-d6eb-4648-b9eb-1f8d2c986fb2 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung1h" → NAV — → /dispatch/leads/a2f29757-d6eb-4648-b9eb-1f8d2c986fb2 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung2h" → NAV — → /dispatch/leads/ec614339-1018-41f9-a15c-fca04760f66c _(btn-nav)_
- ℹ️ **INFO:** Audit-Cap erreicht (25) — 5 Elemente nicht getestet _(audit-cap)_
- ℹ️ **INFO:** Audit "dispatch/dispatch/dashboard" Summary: NAV=23 MODAL=0 NOOP=1 ERROR=0 _(audit-summary)_
- ℹ️ **INFO:** Button-Audit "dispatch/dispatch/leads": 165 klickbare Elemente gefunden (max 25) _(audit-inventory)_
...
- ℹ️ **INFO:** Audit-Cap erreicht (25) — 140 Elemente nicht getestet _(audit-cap)_
...
- ✅ **PASS:** Button "Posteingang öffnen" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit "sv/gutachter/heute" Summary: NAV=5 MODAL=0 NOOP=9 ERROR=5 _(audit-summary)_
...
- ✅ **PASS:** Button "Tagesvorbereitung CSV" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ✅ **PASS:** Button "Alle" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ⚠️ **SOFT:** Button "Neue" → ERROR — Console-Errors: %c%s%c Only plain objects can be passed to Client Components from Server Components. Classes or other objects with methods are not supported.%s background: #e6e6e6;background: light-dark(rgba(0,0,0,0. _(btn-error)_
- ✅ **PASS:** Button "Posteingang öffnen" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit "sv/gutachter/auftraege" Summary: NAV=9 MODAL=0 NOOP=5 ERROR=1 _(audit-summary)_
...
- ✅ **PASS:** Button "Posteingang öffnen" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit "sv/gutachter/posteingang" Summary: NAV=10 MODAL=0 NOOP=5 ERROR=0 _(audit-summary)_
...
- ✅ **PASS:** Button "Mein Fall" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
...
- ℹ️ **INFO:** Audit übersprungen (destruktiv): "Abmelden" _(audit-skip-danger)_
- ✅ **PASS:** Button "Los geht's" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit "kunde/kunde/faelle" Summary: NAV=4 MODAL=0 NOOP=2 ERROR=0 _(audit-summary)_
...
- ✅ **PASS:** Claim entstanden: cc3618bb-cfbe-461a-b3d8-4fb331d87e9c (status=dispatch_done) _(db-claim)_
- ✅ **PASS:** Fall entstanden: 01b34331-8fb6-4fac-ae61-e73d37361f6e (status=sv-zugewiesen sa_unterschrieben=true) _(db-fall)_
- ⚠️ **SOFT:** Kein Auftrag in DB obwohl Fall existiert — createErstgutachtenAuftragWennNoetig hat nicht ausgeführt _(db-auftrag-fehlt)_
- ⚠️ **SOFT:** NICHT sichtbar: SV: Auftrag-Card sichtbar in /gutachter/auftraege _(cross-sv-auftrag-sichtbar)_
