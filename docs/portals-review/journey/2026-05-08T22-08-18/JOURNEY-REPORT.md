# Journey-Smoke 2026-05-08T22-08-18
...
- ✅ **PASS:** Lead in DB angelegt: d866026b-6f36-4dc5-8fa6-a2f601fd36c3 (status=quali-offen) _(db-lead)_
...
- ✅ **PASS:** Lead-Detail geöffnet: http://localhost:3000/dispatch/leads/d866026b-6f36-4dc5-8fa6-a2f601fd36c3 _(navigation)_
...
## Phase 3 — PASS:165 SOFT:3 HARD:0
...
- ℹ️ **INFO:** Audit übersprungen (destruktiv): "Abmelden" _(audit-skip-danger)_
- ✅ **PASS:** Button "2Neue Leads heute" → NAV — → /dispatch/leads _(btn-nav)_
- ✅ **PASS:** Button "0Offene Rückrufe" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "2FlowLinks versendet" → NAV — → /dispatch/leads _(btn-nav)_
- ✅ **PASS:** Button "Alle anzeigen" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "Alle anzeigen" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung10m" → NAV — → /dispatch/leads/47e842d2-d7c7-46af-b9ab-716502d2c911 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung27m" → NAV — → /dispatch/leads/0da75f14-077b-4bb2-a9ea-9ecee7ba3a31 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung50m" → NAV — → /dispatch/leads/a2f29757-d6eb-4648-b9eb-1f8d2c986fb2 _(btn-nav)_
...
- ℹ️ **INFO:** Audit "dispatch/dispatch/dashboard" Summary: NAV=21 MODAL=0 NOOP=1 ERROR=0 _(audit-summary)_
- ℹ️ **INFO:** Button-Audit "dispatch/dispatch/leads": 159 klickbare Elemente gefunden (max 25) _(audit-inventory)_
...
- ℹ️ **INFO:** Audit-Cap erreicht (25) — 134 Elemente nicht getestet _(audit-cap)_
...
- ℹ️ **INFO:** Audit übersprungen (destruktiv): "Abmelden" _(audit-skip-danger)_
- ✅ **PASS:** Button "Posteingang öffnen" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit "sv/gutachter/heute" Summary: NAV=5 MODAL=0 NOOP=8 ERROR=0 _(audit-summary)_
...
- ✅ **PASS:** Signatur auf Canvas gezeichnet _(canvas-drawn)_
