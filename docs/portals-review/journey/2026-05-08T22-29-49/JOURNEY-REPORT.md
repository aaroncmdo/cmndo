# Journey-Smoke 2026-05-08T22-29-49
...
- ✅ **PASS:** Lead in DB angelegt: 137a6806-fbc6-4534-89d0-275bd91e6bfd (status=quali-offen) _(db-lead)_
...
- ✅ **PASS:** Lead-Detail geöffnet: http://localhost:3000/dispatch/leads/137a6806-fbc6-4534-89d0-275bd91e6bfd _(navigation)_
...
- ✅ **PASS:** Button "Kalender" → NAV — → /admin/kalender _(btn-nav)_
- ✅ **PASS:** Button "00:46SV-Termin: 2026-0001SV" → NAV — → /faelle/d81934ee-5772-41aa-ad73-784fedc5142c _(btn-nav)_
...
- ✅ **PASS:** Button "2026-0001" → NAV — → /faelle/d81934ee-5772-41aa-ad73-784fedc5142c _(btn-nav)_
- ✅ **PASS:** Button "button#24" → MODAL — Pop-Over/Modal geöffnet _(btn-modal)_
- ✅ **PASS:** Button "Lisa Mueller" → NAV — → /faelle/d81934ee-5772-41aa-ad73-784fedc5142c _(btn-nav)_
- ✅ **PASS:** Button "Karte verschieben" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
...
- ℹ️ **INFO:** Audit übersprungen (destruktiv): "Abmelden" _(audit-skip-danger)_
- ✅ **PASS:** Button "5Neue Leads heute" → NAV — → /dispatch/leads _(btn-nav)_
- ✅ **PASS:** Button "0Offene Rückrufe" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "5FlowLinks versendet" → NAV — → /dispatch/leads _(btn-nav)_
- ✅ **PASS:** Button "Alle anzeigen" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "Alle anzeigen" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung3m" → NAV — → /dispatch/leads/137a6806-fbc6-4534-89d0-275bd91e6bfd _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung10m" → NAV — → /dispatch/leads/65a24d63-f2c6-4e9c-b494-9e811ec9b0c5 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung17m" → NAV — → /dispatch/leads/bc7319b4-1501-40fa-9bf6-f500f7cbde3c _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung32m" → NAV — → /dispatch/leads/47e842d2-d7c7-46af-b9ab-716502d2c911 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung49m" → NAV — → /dispatch/leads/0da75f14-077b-4bb2-a9ea-9ecee7ba3a31 _(btn-nav)_
...
- ℹ️ **INFO:** Button-Audit "dispatch/dispatch/leads": 168 klickbare Elemente gefunden (max 25) _(audit-inventory)_
...
- ℹ️ **INFO:** Audit-Cap erreicht (25) — 143 Elemente nicht getestet _(audit-cap)_
...
- ✅ **PASS:** Button "Posteingang öffnen" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit "sv/gutachter/heute" Summary: NAV=6 MODAL=0 NOOP=8 ERROR=5 _(audit-summary)_
...
[2m  - waiting for locator('a _(btn-click-fail)_
- ✅ **PASS:** Button "Posteingang öffnen" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit "sv/gutachter/auftraege" Summary: NAV=9 MODAL=0 NOOP=6 ERROR=1 _(audit-summary)_
...
- ✅ **PASS:** Button "Mein Fall" → NAV — → /kunde/faelle/d81934ee-5772-41aa-ad73-784fedc5142c _(btn-nav)_
...
- ✅ **PASS:** Claim entstanden: 35029120-54c5-47a7-ab61-7e6e01826157 (status=dispatch_done) _(db-claim)_
- ✅ **PASS:** Fall entstanden: d81934ee-5772-41aa-ad73-784fedc5142c (status=sv-zugewiesen sa_unterschrieben=true) _(db-fall)_
- ✅ **PASS:** Auftrag entstanden: eda0ff24-4d54-40b4-8521-2c652fcd932e typ=erstgutachten status=termin _(db-auftrag)_
