# Journey-Smoke 2026-05-08T22-00-40
...
- ✅ **PASS:** Lead in DB angelegt: 47e842d2-d7c7-46af-b9ab-716502d2c911 (status=quali-offen) _(db-lead)_
...
- ✅ **PASS:** Lead-Detail geöffnet: http://localhost:3000/dispatch/leads/47e842d2-d7c7-46af-b9ab-716502d2c911 _(navigation)_
...
## Phase 3 — PASS:167 SOFT:4 HARD:0
...
- ℹ️ **INFO:** Audit übersprungen (destruktiv): "Abmelden" _(audit-skip-danger)_
- ✅ **PASS:** Button "1Neue Leads heute" → NAV — → /dispatch/leads _(btn-nav)_
- ✅ **PASS:** Button "0Offene Rückrufe" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "1FlowLinks versendet" → NAV — → /dispatch/leads _(btn-nav)_
- ✅ **PASS:** Button "Alle anzeigen" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "Alle anzeigen" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung2m" → NAV — → /dispatch/leads/47e842d2-d7c7-46af-b9ab-716502d2c911 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung19m" → NAV — → /dispatch/leads/0da75f14-077b-4bb2-a9ea-9ecee7ba3a31 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung42m" → NAV — → /dispatch/leads/a2f29757-d6eb-4648-b9eb-1f8d2c986fb2 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung1h" → NAV — → /dispatch/leads/7934bfd2-0371-4f39-9c7e-5a41f76c11de _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung1h" → NAV — → /dispatch/leads/7934bfd2-0371-4f39-9c7e-5a41f76c11de _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung1h" → NAV — → /dispatch/leads/7934bfd2-0371-4f39-9c7e-5a41f76c11de _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung1h" → NAV — → /dispatch/leads/7934bfd2-0371-4f39-9c7e-5a41f76c11de _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung1h" → NAV — → /dispatch/leads/7934bfd2-0371-4f39-9c7e-5a41f76c11de _(btn-nav)_
...
- ℹ️ **INFO:** Button-Audit "dispatch/dispatch/leads": 156 klickbare Elemente gefunden (max 25) _(audit-inventory)_
...
- ℹ️ **INFO:** Audit-Cap erreicht (25) — 131 Elemente nicht getestet _(audit-cap)_
...
- ✅ **PASS:** Button "Posteingang öffnen" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit "sv/gutachter/heute" Summary: NAV=5 MODAL=0 NOOP=8 ERROR=1 _(audit-summary)_
...
- ✅ **PASS:** Button "Fall CLM-20260506-001 öffnen" → NAV — → /gutachter/fall/d55caafd-0751-412a-b706-3ba4f8184585 _(btn-nav)_
- ✅ **PASS:** Button "Posteingang öffnen" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit "sv/gutachter/auftraege" Summary: NAV=10 MODAL=0 NOOP=8 ERROR=1 _(audit-summary)_
...
## Phase 4 — PASS:2 SOFT:1 HARD:0

- ℹ️ **INFO:** Kein FlowLink für Lead — lege via Service-Role an (nicht Teil des UI-Tests) _(flowlink-create)_
- ✅ **PASS:** FlowLink verfügbar: token=journey-moxg… status=versendet _(flowlink-ready)_
- ✅ **PASS:** FlowLink-Page geladen ohne Fehler _(flowlink-loaded)_
- ℹ️ **INFO:** Wizard-Schritt 0: Kein klickbarer "Weiter"-Button — vermutlich Pflichtfeld nötig _(wizard-step-blocked)_
- ⚠️ **SOFT:** Kein Signature-Canvas erreichbar — Wizard hängt vor SA-Schritt _(canvas-fehlt)_
