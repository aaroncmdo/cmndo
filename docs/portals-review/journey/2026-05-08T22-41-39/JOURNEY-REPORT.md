# Journey-Smoke 2026-05-08T22-41-39
...
- ✅ **PASS:** Lead in DB angelegt: abef5fec-8cf6-4d0f-9197-81ca30cb9e00 (status=quali-offen) _(db-lead)_
...
- ✅ **PASS:** Lead-Detail geöffnet: http://localhost:3000/dispatch/leads/abef5fec-8cf6-4d0f-9197-81ca30cb9e00 _(navigation)_
...
## Phase 3 — PASS:169 SOFT:2 HARD:0
...
- ✅ **PASS:** Button "Kalender" → NAV — → /admin/kalender _(btn-nav)_
- ✅ **PASS:** Button "00:58SV-Termin: 2026-0001SV" → NAV — → /faelle/c3c92527-ff11-4dd8-952a-b3db3b62a481 _(btn-nav)_
...
- ✅ **PASS:** Button "2026-0001" → NAV — → /faelle/c3c92527-ff11-4dd8-952a-b3db3b62a481 _(btn-nav)_
- ✅ **PASS:** Button "button#24" → MODAL — Pop-Over/Modal geöffnet _(btn-modal)_
- ✅ **PASS:** Button "Lisa Mueller" → NAV — → /faelle/c3c92527-ff11-4dd8-952a-b3db3b62a481 _(btn-nav)_
- ✅ **PASS:** Button "Karte verschieben" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
...
- ℹ️ **INFO:** Audit übersprungen (destruktiv): "Abmelden" _(audit-skip-danger)_
- ✅ **PASS:** Button "6Neue Leads heute" → NAV — → /dispatch/leads _(btn-nav)_
- ✅ **PASS:** Button "0Offene Rückrufe" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "6FlowLinks versendet" → NAV — → /dispatch/leads _(btn-nav)_
- ✅ **PASS:** Button "Alle anzeigen" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "Alle anzeigen" → NAV — → /dispatch/rueckrufe _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung3m" → NAV — → /dispatch/leads/abef5fec-8cf6-4d0f-9197-81ca30cb9e00 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung22m" → NAV — → /dispatch/leads/65a24d63-f2c6-4e9c-b494-9e811ec9b0c5 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung29m" → NAV — → /dispatch/leads/bc7319b4-1501-40fa-9bf6-f500f7cbde3c _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung36m" → NAV — → /dispatch/leads/d866026b-6f36-4dc5-8fa6-a2f601fd36c3 _(btn-nav)_
- ✅ **PASS:** Button "Lisa Mueller+4915199990001 In Qualifizierung44m" → NAV — → /dispatch/leads/47e842d2-d7c7-46af-b9ab-716502d2c911 _(btn-nav)_
...
- ℹ️ **INFO:** Audit "dispatch/dispatch/dashboard" Summary: NAV=22 MODAL=0 NOOP=1 ERROR=0 _(audit-summary)_
- ℹ️ **INFO:** Button-Audit "dispatch/dispatch/leads": 171 klickbare Elemente gefunden (max 25) _(audit-inventory)_
...
- ℹ️ **INFO:** Audit-Cap erreicht (25) — 146 Elemente nicht getestet _(audit-cap)_
...
- ℹ️ **INFO:** Audit übersprungen (destruktiv): "Abmelden" _(audit-skip-danger)_
- ✅ **PASS:** Button "Posteingang öffnen" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit "sv/gutachter/heute" Summary: NAV=6 MODAL=0 NOOP=7 ERROR=0 _(audit-summary)_
...
- ✅ **PASS:** Button "In Bearbeitung" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
...
- ⚠️ **SOFT:** Button "Fall CLM-20260506-001 öffnen" → ERROR — Console-Errors: %c%s%c [fall-queries] getFallForSv: background: #e6e6e6;background: light-dark(rgba(0,0,0,0.1), rgba(255,255,255,0.25));color: #000000;color: light-dark(#000000, #ffffff);border-radius: 2px  Server    _(btn-error)_
- ✅ **PASS:** Button "Posteingang öffnen" → NOOP — kein sichtbarer State-Wechsel _(btn-noop)_
- ℹ️ **INFO:** Audit "sv/gutachter/auftraege" Summary: NAV=11 MODAL=0 NOOP=8 ERROR=1 _(audit-summary)_
...
- ✅ **PASS:** Button "Mein Fall" → NAV — → /kunde/faelle/c3c92527-ff11-4dd8-952a-b3db3b62a481 _(btn-nav)_
...
- ✅ **PASS:** Claim entstanden: 78eb4af6-bdd4-49a5-bc8c-34eb2d72eb74 (status=dispatch_done) _(db-claim)_
- ✅ **PASS:** Fall entstanden: c3c92527-ff11-4dd8-952a-b3db3b62a481 (status=sv-zugewiesen sa_unterschrieben=true) _(db-fall)_
- ✅ **PASS:** Auftrag entstanden: 1736a9a3-1aab-4a43-9d0f-1f623c3aaad4 typ=erstgutachten status=termin _(db-auftrag)_
