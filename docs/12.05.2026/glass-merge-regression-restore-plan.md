...
- [ ] **4b** — `feldmodus/AktuellerStopCard.tsx` C9-Reimplementierung + Glass-Overlay in `FeldmodusClient` (eigene Session, groß — Reimplementierung des C9-Styling auf der Auto-Arrive-Architektur) ← *als nächstes*
