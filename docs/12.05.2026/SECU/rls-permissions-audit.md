...
> **Status (13.05.2026):** Alle Items aus dieser Detail-Referenz via Folge-Audit `docs/13.05.2026/db-rls-audit/AUDIT-2026-05-13-DONE.md` bearbeitet — 11 PRs gemerged, Live-Advisor-Lints von 201 → ~30 (Rest sind by-design oder out-of-scope). Bleibt als Historie/Detail-Referenz.
