...
// PoC-Preview-Mirror des App-Polish (src/remotion/ContentClip.tsx). System-Font.
const NAVY = '#0D1B3E'
const ACCENT = '#4573A2'
const CREAM = '#F5F1E8'
...
function BrandWatermark() {
  return (
    <AbsoluteFill style={{ justifyContent: 'flex-start', alignItems: 'flex-start', padding: 46 }}>
      <div style={{ fontFamily: FONT, fontWeight: 800, fontSize: 30, color: CREAM, opacity: 0.82, letterSpacing: 0.5 }}>claimondo</div>
    </AbsoluteFill>
  )
}
