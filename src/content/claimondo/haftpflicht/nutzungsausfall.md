...
NAE · Nutzungsausfallentschädigung · Pauschale Mobilitäts-Entschädigung · Fahrzeug-Vorenthaltungs-Schaden
...
Drei Bedingungen müssen vorliegen:
...
| Position | Wert |
|---|---|
| Fahrzeug-Klasse | C (Mittelklasse, VW Passat) |
| Tagessatz | 55 €/Tag |
| Reparatur-Dauer | 14 Tage |
| **Nutzungsausfall** | **770 €** |

### Beispiel bei Totalschaden

| Position | Wert |
|---|---|
| Klasse | D (Obere Mittelklasse) |
| Tagessatz | 79 €/Tag |
| Wiederbeschaffungs-Dauer | 14 Tage (BGH-Standard) |
...
Bei Unsicherheit: SV-Gutachten enthält die Klasse.

**2. Reparatur-Dauer dokumentieren**
Werkstatt-Auftrag, Rückgabe-Datum, ggf. Ersatzteil-Wartezeiten. Bei Totalschaden: 14 Tage Wiederbeschaffungs-Dauer als Standard.

**3. Anspruch schriftlich geltend machen**
Im Anspruchsschreiben Nutzungsausfall separat aufführen. Konkrete Bezifferung (Tagessatz × Dauer).

---

## Häufige Fragen

**Wie hoch ist Nutzungsausfall pro Tag?**
