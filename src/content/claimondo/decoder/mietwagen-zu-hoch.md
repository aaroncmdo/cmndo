...
Mietwagen-Kürzung · Tagessatz-Streit · Unfall-Ersatz-Tarif-Streit · Schwacke-Fraunhofer-Differenz
...
### Mietwagen-Anspruch nach BGH
Voraussetzungen für die Erstattung:
- Reparatur-Dauer oder Wiederbeschaffungs-Zeit machen Mietwagen notwendig
- Kein verfügbarer Zweitwagen
...
- Eine Klasse unter dem eigenen Wagen ist typischerweise **zumutbar** (Schadensminderungs-Pflicht)
- Premium-Fahrzeug → ggf. nur Mittelklasse erstattbar
...
zurück. Nach BGH-Linie ist der „ortsübliche Normaltarif"
maßgeblich.

Auswertung Schwacke + Fraunhofer für meine PLZ [PLZ] und
Mietwagen-Kategorie [Klasse]:

- Schwacke-Tagessatz: [X] €
- Fraunhofer-Tagessatz: [Y] €
- Misch-Mittel (BGH-Linie): [(X+Y)/2] €

Mein gewählter Tagessatz von [Mein Tagessatz] € liegt im
Bereich des ortsüblichen Normaltarifs.

Hinzu kommt: Zum Zeitpunkt der Anmietung war ein günstigerer
Tarif nicht verfügbar (Begründung: Akut-Lage / Wochenende /
Region — siehe beigefügte Vergleichs-Anfragen).

Ich erbitte vollständige Erstattung der Mietwagenkosten in
Höhe von [Tagessatz × Tage] €.
