...
export async function ladeRangConfig(supabase: Sb): Promise<RangConfig> {
  ...
  return {
    ...
    ratingNormFloor: g('rating_norm_floor', DEFAULT_RANG_CONFIG.ratingNormFloor),
    ratingNormSpan: g('rating_norm_span', DEFAULT_RANG_CONFIG.ratingNormSpan),
    sinnsatzTopRating: g('sinnsatz_top_rating', DEFAULT_RANG_CONFIG.sinnsatzTopRating),
