...
// mit beliebiger abrechnungId aufrufen (Abrechnung stornieren/re-issuen, Stripe-PI
// canceln, Empfaenger-Mail ausloesen). Alle Caller sind server-seitig
// (admin/abrechnungen/actions, revertCaseBilling); die Guards leben dort.
