...
export const FALL_STATUS_LABELS: Record<string, string> = {
  ...
  besichtigung: 'Besichtigung laeuft',
  'gutachten-eingegangen': 'Gutachten eingegangen',
  filmcheck: 'Qualitaetspruefung',
  'qc-pruefung': 'Qualitaetspruefung',
  'kanzlei-uebergeben': 'An Kanzlei uebergeben',
  anschlussschreiben: 'Anspruchsschreiben gesendet',
  'as-gesendet': 'Anspruchsschreiben gesendet',
  regulierung: 'Regulierung laeuft',
  'vs-regulierung': 'Regulierung laeuft',
