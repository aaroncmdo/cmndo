        ...
        <section className="bg-white rounded-ios-md border border-claimondo-border p-5 space-y-5">
          <div>
            ...
            <div className="mt-2 flex items-center gap-2">
              <code className="flex-1 font-mono text-2xl md:text-3xl font-bold text-claimondo-navy bg-claimondo-bg border border-claimondo-border rounded-lg px-4 py-3 tracking-wider">
                {code}
              </code>
              <button
                type="button"
                onClick={() => copy(code, 'code')}
                className="shrink-0 inline-flex items-center justify-center w-11 h-11 rounded-lg bg-claimondo-navy text-white hover:bg-claimondo-shield"
          ...
          <div>
            ...
            <div className="mt-2 flex items-center gap-2">
              <input
                readOnly
                value={landingUrl}
                className="flex-1 font-mono text-sm text-claimondo-navy bg-claimondo-bg border border-claimondo-border rounded-lg px-3 py-2.5 truncate"
                onFocus={(e) => e.currentTarget.select()}
              />
              <button
                type="button"
                onClick={() => copy(landingUrl, 'url')}
                className="shrink-0 inline-flex items-center gap-1.5 px-3 h-10 rounded-lg bg-white border border-claimondo-border text-sm text-claimondo-navy hover:border-claimondo-ondo"
              >
                {copied === 'url' ? (
                  <>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex gap-2">
                <button
                  type="button"
                  onClick={downloadPng}
                  className="inline-flex items-center gap-1.5 px-3 h-8 rounded-lg bg-claimondo-navy text-white text-xs font-semibold hover:bg-claimondo-shield"
                >
                ...
                <button
                  type="button"
                  onClick={downloadSvg}
                  className="inline-flex items-center gap-1.5 px-3 h-8 rounded-lg bg-white border border-claimondo-border text-xs font-semibold text-claimondo-navy hover:border-claimondo-ondo"
                >
            ...
            <div
              className="flex items-center justify-center p-4 rounded-xl bg-claimondo-bg border border-claimondo-border"
        ...
        <section className="space-y-5">
          ...
          <div className="bg-white rounded-ios-md border border-claimondo-border p-5">
            ...
            <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2">
              ...
              <a
                href={mailHref}
                className="inline-flex items-center gap-2 px-3 h-10 rounded-lg bg-claimondo-navy text-white text-sm font-semibold hover:bg-claimondo-shield"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-3 h-10 rounded-lg bg-white border border-claimondo-border text-sm font-semibold text-claimondo-navy hover:border-claimondo-ondo"
              >
                {copied === 'share' ? (
                  <>
