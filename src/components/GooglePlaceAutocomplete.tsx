...
export default function GooglePlaceAutocomplete({
  ...
  const defaultCls = 'w-full px-4 py-3 rounded-xl border border-claimondo-border bg-white text-claimondo-navy placeholder-claimondo-ondo/60 text-sm focus:outline-none focus:border-claimondo-ondo transition-colors'
