                ...
                <ul className="space-y-1.5">
                  {items.map((d) => {
                    ...
                    return (
                      <li
                        key={d.id}
                        className="flex items-center gap-3 rounded-ios-xl border border-claimondo-border bg-claimondo-bg p-2.5"
                      >
                        <div className="w-8 h-8 rounded-ios-lg bg-white border border-claimondo-border text-claimondo-ondo flex items-center justify-center flex-shrink-0">
