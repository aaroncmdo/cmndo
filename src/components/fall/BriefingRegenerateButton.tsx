...
export default function BriefingRegenerateButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={pending}
      className="inline-flex items-center gap-1 text-[11px] font-medium px-2.5 py-1 rounded-ios-md border border-claimondo-border text-claimondo-ondo hover:bg-claimondo-bg disabled:opacity-50"
    >
      <RefreshCwIcon
