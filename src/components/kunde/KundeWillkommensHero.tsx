        ...
        <div className="relative p-6 sm:p-10 max-w-md text-white space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <Link
              ...
              className="inline-flex items-center gap-2 bg-white text-claimondo-navy hover:bg-[#f8f9fb] rounded-xl px-5 py-3 text-sm font-semibold shadow-md transition-colors"
            >
              Schaden melden
