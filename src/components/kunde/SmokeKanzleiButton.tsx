...
export default function SmokeKanzleiButton({ fallId }: { fallId: string }) {
  ...
  return (
    <div className="rounded-ios-xl border-2 border-dashed border-amber-400 bg-amber-50/60 p-3 text-xs">
      <div className="flex items-start justify-between gap-3 flex-wrap">
        ...
        <div className="flex gap-2 shrink-0">
          <button
            ...
            onClick={resetWunsch}
            disabled={pending}
            className="inline-flex items-center gap-1.5 rounded-ios-lg bg-amber-600 hover:bg-amber-700 text-white text-xs font-semibold px-3 py-1.5 disabled:opacity-50 transition-colors"
          >
          ...
          <button
            ...
            disabled={pending}
            className="inline-flex items-center gap-1.5 rounded-ios-lg bg-[#0e5be9] hover:bg-claimondo-navy text-white text-xs font-semibold px-3 py-1.5 disabled:opacity-50 transition-colors"
          >
          ...
          <button
            ...
            disabled={pending}
            className="inline-flex items-center gap-1.5 rounded-ios-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold px-3 py-1.5 disabled:opacity-50 transition-colors"
          >
          ...
          <button
            ...
            disabled={pending}
            className="inline-flex items-center gap-1.5 rounded-ios-lg bg-orange-600 hover:bg-orange-700 text-white text-xs font-semibold px-3 py-1.5 disabled:opacity-50 transition-colors"
          >
