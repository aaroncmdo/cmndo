...
export default function EigeneKanzleiPaketCard({
  ...
  if (bereitsVersendet) {
    const datum = uebergebenAm
      ...
      : null
    return (
      <div className="rounded-lg bg-claimondo-ondo/[0.06] border border-claimondo-ondo/30 p-3 text-xs text-claimondo-navy flex items-start gap-2">
  ...
  return (
    <div className="rounded-lg border border-claimondo-ondo/50 bg-white p-3 space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        <label className="block">
          ...
          <input
            ...
            className="mt-1 w-full rounded-md border border-claimondo-border px-2.5 py-1.5 text-xs focus:border-claimondo-ondo focus:outline-none"
          />
        </label>
        <label className="block">
      ...
      <div className="flex flex-wrap gap-2 justify-end">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-md bg-claimondo-navy hover:bg-claimondo-navy disabled:bg-claimondo-ondo/60 text-white text-xs font-semibold px-3 py-1.5 transition-colors"
          title={
            !gutachtenFreigegeben
