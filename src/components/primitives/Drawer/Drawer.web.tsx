        ...
        style={
          {
            ...
            // CSS-Custom-Property für md+ Breite — arbitrary-value-Klassen
            // mit CSS-Variablen können zur Build-Zeit keine numerischen
            // JS-Werte einbauen, siehe md:w-[var(--drawer-w)] oben.
            '--drawer-w': `${width}px`,
