      ...
      <div className="relative">
        ...
        {chat.unreadCount > 0 && !chat.open && (
          <span className="absolute -top-1 -right-1 pointer-events-none">
            <DropletBadge count={chat.unreadCount} colorCls="bg-danger text-white" size={18} />
          </span>
        )}
        ...
        <button
          ...
          className="absolute -top-1.5 -left-1.5 w-4 h-4 rounded-full bg-claimondo-shield text-white flex items-center justify-center opacity-100 md:opacity-0 md:group-hover:opacity-100 hover:bg-danger transition-all"
