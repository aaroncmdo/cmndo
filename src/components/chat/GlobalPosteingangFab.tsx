...
export function GlobalPosteingangFab({ currentUserId }: { currentUserId: string | null }) {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 right-4 z-[9990] flex items-end gap-2">
          ...
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                className="absolute bottom-14 right-0 w-80 glass-light border border-claimondo-border rounded-ios-lg shadow-ios-lg overflow-hidden flex flex-col z-[9995]"
                style={{ maxHeight: 480 }}
              >
