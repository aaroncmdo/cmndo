              ...
              >
                ...
                <div className="flex items-center gap-2 px-4 py-3 bg-white/40 backdrop-blur-sm border-b border-claimondo-border shrink-0">
                  ...
                  {view === 'inbox' && totalUnread > 0 && (
                    <DropletBadge count={totalUnread} colorCls="bg-danger text-white" size={18} />
                  )}
                  <button
                    type="button"
                      ...
                      >
                        ...
                        <div className="flex flex-col items-end gap-1.5 shrink-0">
                          {thread.unreadCount > 0 && (
                            <DropletBadge count={thread.unreadCount} colorCls="bg-danger text-white" size={18} />
                          )}
          ...
          >
            ...
            {totalUnread > 0 && (
              <span className="absolute -top-1 -right-1 pointer-events-none">
                <DropletBadge count={totalUnread} colorCls="bg-danger text-white" size={20} />
              </span>
            )}
          </motion.button>
        </div>
