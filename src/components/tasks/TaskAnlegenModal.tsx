      ...
      <div className="flex flex-col max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-4 space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full text-sm rounded-ios-md border border-claimondo-border px-2 py-1.5 outline-none focus:border-claimondo-ondo"
            />
          </div>
        ...
        <div className="flex justify-end gap-2 border-t border-claimondo-border p-3">
          ...
          <button
            ...
            onClick={submit}
            disabled={pending}
            className="px-3 py-1.5 rounded-ios-md bg-claimondo-ondo text-white text-xs font-medium hover:bg-claimondo-navy disabled:opacity-50 inline-flex items-center gap-1.5"
          >
