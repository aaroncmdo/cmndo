    ...
    return (
      <div className="space-y-1">
        ...
        {events.length === 0 ? (
          ...
          <div className="border border-claimondo-border rounded-xl bg-white px-3">
            {events.map((e) => (
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        {events.length === 0 ? (
          <div className="border-2 border-dashed border-claimondo-border rounded-xl py-10 text-center text-sm text-claimondo-light-blue">
            Noch keine Events im Verlauf
          </div>
        ) : (
          <div className="border border-claimondo-border rounded-xl bg-white px-4">
            {events.map((e) => (
              <TimelineEventCard
                key={e.event_id}
                event={e}
