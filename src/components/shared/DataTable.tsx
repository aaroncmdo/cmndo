...
// (gewinnt über die Defaults, weil sie nach dem Default-String stehen — falls
// nicht, `!`-Prefix). Token-gebunden (claimondo-* → var(--brand-*)). Mobile-
// Karten-Fallbacks bleiben Caller-Sache (die Regel betrifft die Tabelle, nicht
