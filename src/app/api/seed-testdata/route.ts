...
export async function POST() {
  ...
  try {
    ...
    const leadDefs = [
      {
        vorname: 'Max', nachname: 'Mustermann', telefon: '0176-12345678', email: 'max@email.de',
      ...
      {
        vorname: 'Anna', nachname: 'Klein', telefon: '0171-98765432', email: 'anna@email.de',
        fahrzeug_hersteller: 'VW', fahrzeug_modell: 'Golf',
        schadenfall_typ: 'sf-01', kunden_konstellation: 'kk-01',
        status: 'quali-offen' as const, mietwagen_flag: true, created_at: daysAgo(5),
      },
      {
        vorname: 'Peter', nachname: 'Gross', telefon: '0172-55544433', email: 'peter@email.de',
      ...
      {
        vorname: 'Julia', nachname: 'Braun', telefon: '0173-11122233', email: 'julia@email.de',
      ...
      {
        vorname: 'Thomas', nachname: 'Neumann', telefon: '0174-33344455', email: 'thomas.n@email.de',
        fahrzeug_hersteller: 'Ford', fahrzeug_modell: 'Focus',
        schadenfall_typ: 'sf-01', kunden_konstellation: 'kk-01',
        status: 'neu' as const, created_at: daysAgo(1),
      },
      {
        vorname: 'Sandra', nachname: 'Hoffmann', telefon: '0175-44455566', email: 'sandra@email.de',
      ...
      {
        vorname: 'Michael', nachname: 'Richter', telefon: '0176-55566677', email: 'michael@email.de',
        fahrzeug_hersteller: 'Toyota', fahrzeug_modell: 'Corolla',
        schadenfall_typ: 'sf-01', kunden_konstellation: 'kk-01',
        status: 'quali-offen' as const, created_at: daysAgo(4),
      },
      {
        vorname: 'Laura', nachname: 'Bauer', telefon: '0177-66677788', email: 'laura@email.de',
      ...
      {
        vorname: 'Stefan', nachname: 'Koch', telefon: '0178-77788899', email: 'stefan@email.de',
      ...
      {
        vorname: 'Martina', nachname: 'Wolf', telefon: '0179-88899900', email: 'martina@email.de',
