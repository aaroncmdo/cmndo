  ...
  try {
    ...
    for (const sv of gutachterDefs) {
      ...
      const { data: newSv, error: svErr } = await admin.from('sachverstaendige').insert({
        ...
        paket_umkreis_km: sv.paket_umkreis_km,
        werbebudget_guthaben_netto: sv.guthaben ?? 0,
    ...
    const leadDefs = [
      ...
      },
      {
        ...
        schadens_fall_typ: 'sf-02', kunden_konstellation: 'kk-01',
      ...
      },
      {
        ...
        schadens_fall_typ: 'sf-03', kunden_konstellation: 'kk-01',
      ...
      },
      {
        ...
        schadens_fall_typ: 'sf-01', kunden_konstellation: 'kk-04',
    ...
    for (const l of leadDefs) {
      ...
      const insertData: Record<string, unknown> = {
        ...
        schadens_fall_typ: l.schadens_fall_typ, kunden_konstellation: l.kunden_konstellation,
