  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-12 font-[family-name:var(--font-montserrat)]">
      ...
      <div className="prose prose-sm text-claimondo-shield/80 space-y-6">
        <section>
          <h2 className="text-lg font-semibold text-claimondo-shield">1. Geltungsbereich</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-claimondo-shield">2. Leistungsbeschreibung</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-claimondo-shield">3. Kosten für den Geschädigten</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-claimondo-shield">4. Sicherungsabtretung</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-claimondo-shield">5. Datenschutz</h2>
          <p>Die Verarbeitung personenbezogener Daten erfolgt gemäß unserer <a href="/datenschutz" className="text-claimondo-ondo underline">Datenschutzerklärung</a>.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-claimondo-shield">6. Haftung</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-claimondo-shield">7. Schlussbestimmungen</h2>
