      ...
      {tab === 'google' && (
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="w-full py-3.5 rounded-ios-md bg-claimondo-shield hover:bg-claimondo-ondo text-white text-white font-semibold text-sm active:scale-[0.98] transition-all flex items-center justify-center gap-3"
          >
