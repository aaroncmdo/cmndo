...
export default function LoginClient({
  ...
  return (
    <div>
      ...
      {tab === 'telefon' && (
        <div className="flex flex-col gap-4">
          {phoneStep === 'enter' ? (
            ...
            <>
              <p className="text-gray-500 text-sm">Code gesendet an <span className="text-gray-900">{phone}</span></p>
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  placeholder="123456"
                  maxLength={6}
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-gray-100 text-gray-900 placeholder-zinc-500 text-sm text-center tracking-[0.5em] font-mono focus:outline-none focus:border-zinc-500 focus:ring-2 focus:ring-zinc-700 transition-all"
                />
              </div>
              {phoneError && (
                <p className="text-sm text-red-400 rounded-xl bg-red-50/50 border border-red-200 px-4 py-3">{phoneError}</p>
      ...
      {tab === 'google' && (
        <div className="flex flex-col gap-4">
          <p className="text-gray-500 text-sm text-center">Mit Ihrem Google-Konto anmelden</p>
          <button
            type="button"
