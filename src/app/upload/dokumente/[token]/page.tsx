...
export default async function DokumenteUploadPage({
  ...
  if (!status.ok) {
    ...
    if (status.reason === 'already_complete') {
      return (
        <div style={brandStyle} className="min-h-screen bg-claimondo-bg flex items-center justify-center p-6">
          <div className="bg-white rounded-claimondo-sheet shadow-sheet max-w-md w-full p-10 text-center space-y-4 animate-[sheetIn_.42s_cubic-bezier(.16,1,.3,1)_both]">
    ...
    return (
      <div style={brandStyle} className="min-h-screen bg-claimondo-bg flex items-center justify-center p-6">
        <div className="bg-white rounded-claimondo-sheet shadow-sheet max-w-md w-full p-8 text-center space-y-3 animate-[sheetIn_.42s_cubic-bezier(.16,1,.3,1)_both]">
