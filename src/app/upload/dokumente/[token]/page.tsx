    ...
    const cfg =
      status.reason === 'expired'
        ...
        : status.reason === 'already_complete'
          ? { title: 'Dokumente bereits empfangen', text: 'Wir haben alle angefragten Dokumente bereits erhalten. Falls Sie neue Dokumente schicken möchten, kontaktieren Sie bitte Ihren Ansprechpartner.' }
