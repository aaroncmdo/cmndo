...
export async function starteEmbedBuchung(
  ...
  // 2) gfa → lead → flow_link (Service-Role, idempotent). send:false = kein WA/SMS/Email-Versand,
  //    der Nutzer bucht inline weiter; Token wird trotzdem erzeugt + zurückgegeben.
