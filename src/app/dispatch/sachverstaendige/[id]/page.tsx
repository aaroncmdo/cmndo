      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              <div className="flex items-center gap-2">
                {profile?.telefon ? (
                  ...
                  <><PhoneIcon className="w-4 h-4 text-claimondo-ondo/70" /><span className="text-claimondo-ondo/70">—</span></>
                )}
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="bg-white rounded-xl border border-claimondo-border p-5 space-y-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-sm">
              <div>
                <p className="text-[10px] text-claimondo-ondo/70 uppercase">Adresse</p>
                <p className="font-medium">{(svRec.standort_adresse as string) || '—'}</p>
              </div>
              <div>
                <p className="text-[10px] text-claimondo-ondo/70 uppercase">PLZ</p>
                <p className="font-medium">{(svRec.standort_plz as string) || '—'}</p>
              </div>
              <div>
                <p className="text-[10px] text-claimondo-ondo/70 uppercase">Radius</p>
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl border border-claimondo-border p-4 space-y-3">
            ...
            <p className="text-sm font-semibold text-claimondo-navy">{(svRec.paket as string) ?? '—'}</p>
            <div>
            ...
            <div>
              <p className="text-[10px] text-claimondo-ondo uppercase">Guthaben</p>
              <p className="text-sm font-semibold text-claimondo-navy">{Number(svRec.werbebudget_guthaben_netto || 0).toLocaleString('de-DE', { style: 'currency', currency: 'EUR' })}</p>
            </div>
          </div>
