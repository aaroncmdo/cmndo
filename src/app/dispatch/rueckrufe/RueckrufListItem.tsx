    ...
    <>
      <div className="flex items-center gap-4 px-5 py-4">
        ...
        <button
          ...
          onClick={() => setOpen(true)}
          title="Termin öffnen"
          className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-ios-xl border border-claimondo-border text-claimondo-navy text-xs font-medium hover:border-claimondo-ondo hover:bg-claimondo-bg transition-colors"
        >
