...
export default function SeedButton() {
  ...
  return (
    <div className="bg-zinc-900 border border-dashed border-zinc-700 rounded-2xl p-5">
      ...
      {result && (
        <div className={`mt-3 p-3 rounded-lg text-sm ${result.success ? 'bg-green-950 text-green-300' : 'bg-red-950 text-red-300'}`}>
