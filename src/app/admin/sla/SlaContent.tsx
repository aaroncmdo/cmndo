// AAR-85 → F0: header-loser SLA-Monitoring-Content. Geteilt von /admin/sla (Standalone)
// + /admin/faelle/sla (Hub-Tab). Header liefert die jeweilige Route bzw. der Hub-Header.
...
export default async function SlaContent() {
