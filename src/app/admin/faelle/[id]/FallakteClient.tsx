...
import TerminHistorie from '@/components/faelle/TerminHistorie'
...
export default function FallakteClient({
  ...
  const TASK_TARGET_MAP: Record<string, { tab: Tab; elementId: string }> = {
    ...
    'gutachten-hochladen': { tab: 'dokumente', elementId: 'sa-section' },
    'gutachten-erstellen': { tab: 'dokumente', elementId: 'sa-section' },
    'sa-unterschreiben': { tab: 'dokumente', elementId: 'sa-section' },
    'dokument-hochladen': { tab: 'dokumente', elementId: 'sa-section' },
