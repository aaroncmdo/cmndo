    ...
    <div className="py-8"><div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-5">
        ...
        <form onSubmit={handleSave} className="space-y-3">
          ...
          <button type="submit" disabled={saving} className="flex items-center gap-2 bg-[#4573A2] hover:bg-[#4573A2] disabled:bg-zinc-700 text-white text-sm font-medium px-4 py-2.5 rounded-xl transition-colors">
