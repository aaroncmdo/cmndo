...
export default async function AbrechnungenPage() {
  ...
  const { data, error } = await supabase
    .from('abrechnungen')
    .select('id, abrechnungs_nr, empfaenger_typ, empfaenger_id, empfaenger_name, empfaenger_email, summe_netto, summe_brutto, status, faellig_am, versand_datum, bezahlt_am, bezahlt_betrag, einzug_versucht_am, einzug_fehler, stripe_payment_intent_id, reminder_gesendet_am, storniert_am, created_at, notiz')
