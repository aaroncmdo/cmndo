...
const EVENT_META: Record<EventType, { icon: typeof UserPlusIcon; bg: string; iconColor: string; label: string }> = {
  ...
  vertrag_signiert: { icon: FileSignatureIcon, bg: 'bg-purple-50', iconColor: 'text-claimondo-navy', label: 'Vertrag' },
  ...
  abtretung_upload: { icon: ScrollTextIcon, bg: 'bg-indigo-50', iconColor: 'text-claimondo-navy', label: 'Abtretung' },
}
