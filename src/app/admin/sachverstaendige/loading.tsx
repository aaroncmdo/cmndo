            ...
            <div key={i} className="bg-white border border-claimondo-border rounded-2xl p-5 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-1 flex-1">
                  ...
                  <div className="h-3 w-20 bg-[#f8f9fb]/60 rounded animate-pulse" />
                </div>
              </div>
              <div className="h-3 w-full bg-[#f8f9fb]/40 rounded animate-pulse" />
              <div className="flex gap-2">
                <div className="h-5 w-16 bg-[#f8f9fb] rounded-full animate-pulse" />
                <div className="h-5 w-12 bg-[#f8f9fb]/60 rounded-full animate-pulse" />
              </div>
            </div>
          ))}
        </div>
