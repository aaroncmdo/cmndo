...
export default async function SachverstaendigeHubPage() {
  ...
  const { data: svRaw } = await supabase
    ...
    .select(
      'id, paket, standort_lat, standort_lng, ist_aktiv, organisation_id, isochrone_polygon, paket_umkreis_km, gutachter_typ, offene_faelle, max_faelle_monat, paket_faelle_genutzt, paket_faelle_gesamt, ablehnungen_30_tage, portal_zugang_freigeschaltet, vertrag_unterschrieben, gesperrt_seit, profiles(vorname, nachname)',
    )
