...
const STATUS_COLOR: Record<string, string> = {
  ...
  geschlossen: 'bg-[#f8f9fb] text-claimondo-ondo',
}
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {(probleme ?? []).map(p => {
                  ...
                  return (
                    <tr key={p.id} className="border-b border-claimondo-border hover:bg-[#f8f9fb]">
                      ...
                      <td className="px-4 py-3">
                        <span className="text-[10px] bg-[#f8f9fb] text-claimondo-ondo px-1.5 py-0.5 rounded">{KAT_LABEL[p.kategorie] ?? p.kategorie}</span>
                      </td>
