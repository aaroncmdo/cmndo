...
// F0: geteilter Statistiken-Content (Data-Load + Client). `embedded` blendet den
// eigenen PageHeader aus, wenn der Fälle-Hub-Header den Titel schon liefert.
export default async function StatistikenContent({ embedded = false }: { embedded?: boolean }) {
