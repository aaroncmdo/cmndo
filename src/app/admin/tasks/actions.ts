...
export async function createTask(
  ...
  if (!fallId || !typ || !titel) {
    return { success: false, error: 'Fall, Typ und Titel sind Pflichtfelder' }
  }
...
export async function updateTaskStatus(
  ...
  // Hinweis: updateTaskStatusCore wirft bei DB-Fehlern weiter — Wrapper-
  // try/catch fängt das ab und liefert es als Result.
  try {
