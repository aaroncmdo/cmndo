        ...
        {heutigeRueckrufe.length > 0 && (
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 mb-4">
            <div className="flex items-center gap-2 mb-3">
              <PhoneCallIcon className="w-4 h-4 text-amber-600" />
              <h3 className="text-sm font-semibold text-amber-700">Heutige Rueckrufe ({heutigeRueckrufe.length})</h3>
            </div>
                    ...
                    <Droppable droppableId={col.key}>
                      {(provided, snapshot) => (
                        <div
                          ...
                          className={`space-y-2 min-h-24 rounded-xl p-1 transition-colors ${
...
function LeadCard({ lead, columnKey }: { lead: Lead; columnKey: string }) {
  ...
  return (
    <div className="bg-white rounded-xl p-3 border border-gray-200 hover:border-gray-300 transition-colors cursor-grab active:cursor-grabbing">
      {/* Rueckruf Badge */}
      {hasCallback && (
