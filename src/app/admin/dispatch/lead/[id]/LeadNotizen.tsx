  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 mb-5">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h2 className="text-sm font-medium text-zinc-400">Notizen</h2>
      </div>
      <textarea
        value={text}
        ...
        rows={3}
        className="w-full bg-zinc-800 border border-zinc-700 text-zinc-200 text-sm rounded-xl px-3 py-2.5 focus:outline-none focus:ring-1 focus:ring-blue-500 placeholder-zinc-600 resize-y"
      />
