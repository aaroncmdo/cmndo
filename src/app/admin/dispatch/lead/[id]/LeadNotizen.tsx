  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-5 mb-5">
      ...
      <textarea
        ...
        rows={3}
        className="w-full bg-gray-100 border border-gray-300 text-gray-800 text-sm rounded-xl px-3 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#4573A2] placeholder-gray-400 resize-y"
      />
