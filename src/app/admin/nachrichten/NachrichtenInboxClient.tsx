          ...
          {selected ? (
            <>
              <div className="bg-white rounded-xl border border-gray-200 px-4 py-3 flex items-center justify-between">
                <Link href={`/faelle/${selected.fallId}`} target="_blank" rel="noopener" className="min-w-0 group">
                ...
                <Link href={`/faelle/${selected.fallId}`} target="_blank" rel="noopener" className="text-xs text-[#4573A2] hover:underline inline-flex items-center gap-1">
