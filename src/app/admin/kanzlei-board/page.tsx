    ...
    <div className="py-6 space-y-6">
              ...
              return (
                <tr key={p.id}>
                  <td className="px-4 py-3">
                    <Link href={`/faelle/${p.fall_id}`} target="_blank" rel="noopener" className="text-[#4573A2] hover:underline font-medium">
      ...
      <section className="bg-white rounded-xl border border-gray-200">
        ...
        <div className="divide-y divide-gray-50">
          {(lexdriveTasks ?? []).map(t => (
            <Link key={t.id} href={`/faelle/${t.fall_id}`} target="_blank" rel="noopener" className="block px-4 py-3 hover:bg-gray-50 transition-colors text-sm">
