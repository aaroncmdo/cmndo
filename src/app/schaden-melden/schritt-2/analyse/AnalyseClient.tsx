...
function Done({
  ...
  return (
    <div className="mx-auto max-w-2xl py-6">
      ...
      <section className="rounded-ios-lg border border-claimondo-border bg-white shadow-claimondo-md p-5">
      ...
      {result.beschaedigte_teile.length > 0 ? (
        <section className="mt-4 rounded-ios-lg border border-claimondo-border bg-white shadow-claimondo-md p-5">
