    ...
    <div className="h-full flex items-center justify-center p-8">
      <div className="text-center max-w-3xl w-full">
        ...
        {(error.message || error.digest || error.stack) && (
          <div className="text-left mb-3 rounded-lg bg-gray-50 border border-gray-200 px-3 py-2.5 space-y-2 max-h-80 overflow-y-auto">
            {error.message && (
            ...
            {error.stack && (
              <pre className="text-[10px] font-mono text-gray-600 whitespace-pre-wrap break-all">{error.stack}</pre>
            )}
          </div>
        )}
        <div className="flex items-center justify-center gap-2 mb-3">
          <button
            ...
            className="px-4 py-2 bg-white border border-gray-200 text-gray-700 font-medium text-xs rounded-lg hover:bg-gray-50 transition-colors"
          >
