    ...
    <div className="bg-white rounded-xl border border-claimondo-border shadow-sm p-5 space-y-5">
      ...
      <div className="pt-2">
        <button
          ...
          disabled={pending}
          className="w-full rounded-md bg-claimondo-navy text-white px-3 py-2.5 text-sm font-medium hover:bg-[var(--brand-primary-hover)] disabled:opacity-50 transition-colors"
        >
