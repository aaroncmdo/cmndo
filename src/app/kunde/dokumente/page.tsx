...
export default async function KundeDokumentePage() {
  ...
  return (
    <div className="px-5 py-8">
      <h1 className="text-xl font-bold text-white mb-4" style={{ letterSpacing: '-0.03em' }}>Dokumente</h1>
      <div className="rounded-3xl p-8 text-center" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
        <p style={{ color: 'rgba(255,255,255,0.4)' }} className="text-sm">Noch keine Dokumente vorhanden.</p>
      </div>
    </div>
  )
}
