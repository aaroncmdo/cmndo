...
export default async function KundeTerminPage({
  ...
  //
  // SV-Onboarding-Audit: Branding-Gate auf das kanonische `verifiziert`-Boolean
  // gezogen (= resolveKundenTheme / kunden-theme.ts Business-Rule), statt
  // `verifiziert_am` — letzteres wird auch von Tier-2 (tier2Freigeben) gestempelt,
  // ohne `verifiziert` zu setzen, und konnte so bei einem noch nicht Tier-1-
  // verifizierten SV Whitelabel zeigen, das das Kunde-Portal (resolveKundenTheme)
  // verweigert. Jetzt konsistent.
