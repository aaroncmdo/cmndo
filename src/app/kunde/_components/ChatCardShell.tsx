      ...
      >
        ...
        <div className="flex items-center gap-2.5">
          <div className="relative shrink-0">
            ...
            {unread > 0 && (
              <span
                className="absolute -top-1 -right-1 inline-flex items-center justify-center min-w-[18px] h-[18px] px-1 rounded-full bg-danger text-white text-xs font-bold leading-none ring-2 ring-claimondo-navy"
