...
export default async function EskalierterAdminCard({ vorname, nachname, avatarUrl, accentBg }: Props) {
  ...
  return (
    <div className="mx-3 mb-2 rounded-ios-xl border bg-warning/10 border-warning/30 px-3 py-2.5 relative z-[1102]">
      <p className="text-[9px] uppercase tracking-wider text-warning-soft leading-tight flex items-center gap-1">
