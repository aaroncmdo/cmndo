  ...
  return (
    <SectionCard title="Einbinde-Snippets" icon={<Code2Icon style={{ width: 18, height: 18 }} />}>
      <p className="text-sm text-claimondo-ondo mb-4">
        Füge das jeweilige Snippet einmalig in den <code>&lt;head&gt;</code> Ihrer Website ein.
      </p>
      <div className="space-y-5">
        <SnippetBlock
          label="Schaden-Widget"
          hint="Öffnet das Anfrage-Formular für Ihre Kunden (schwebender Button unten rechts)."
          snippet={monikaSnippet(slug)}
        />
        <SnippetBlock
          label="Login-Button"
          hint={
            'Gebrandeter »Anmelden«-Button für Ihre Kunden — schwebt oben rechts. Für eine feste ' +
