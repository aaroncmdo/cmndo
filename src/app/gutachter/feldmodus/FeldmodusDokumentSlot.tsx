      ...
      {canReplace && (
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg bg-[#1E3A5F] hover:bg-[#4573A2] text-white text-xs font-medium disabled:opacity-50"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg border border-[#4573A2] text-[#4573A2] text-xs font-medium disabled:opacity-50"
          >
            {isPending ? (
