    ...
    <div className="h-full overflow-y-auto bg-[#f8f9fb] flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-500 text-sm mb-6 leading-relaxed">
          Vielen Dank! Dein Portal-Zugang ist freigeschaltet — du kannst ab sofort Aufträge erhalten.
          Die Bestätigung mit deinem unterzeichneten Vertrag wurde dir per Email zugeschickt.
        </p>
        <Link
          href="/gutachter"
