            ...
            {!googleConnected && (
              <div className="flex gap-2">
                ...
                <button
                  type="button"
                  disabled
                  title="Outlook-Anbindung folgt"
                  className="flex-1 py-2.5 rounded-xl text-sm font-medium bg-gray-50 text-gray-400 border border-gray-200 cursor-not-allowed"
                >
                  Outlook (bald verfügbar)
                </button>
              </div>
            )}
