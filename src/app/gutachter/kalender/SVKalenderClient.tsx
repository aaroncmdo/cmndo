      ...
      <div className="flex-shrink-0 bg-white border-b border-claimondo-border px-4 py-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2 justify-between sm:justify-end">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <button onClick={() => setCurrentDate(subWeeks(currentDate, 1))} className="px-2.5 sm:px-3 py-1.5 text-xs text-claimondo-ondo hover:text-claimondo-navy hover:bg-[#f8f9fb] rounded-lg transition-colors">← <span className="hidden sm:inline">Zurück</span></button>
            <button onClick={() => setCurrentDate(new Date())} className="px-2.5 sm:px-3 py-1.5 text-xs text-claimondo-navy hover:text-claimondo-navy hover:bg-[#f8f9fb] rounded-lg transition-colors font-medium">Heute</button>
            <button onClick={() => setCurrentDate(addWeeks(currentDate, 1))} className="px-2.5 sm:px-3 py-1.5 text-xs text-claimondo-ondo hover:text-claimondo-navy hover:bg-[#f8f9fb] rounded-lg transition-colors"><span className="hidden sm:inline">Weiter</span> →</button>
          </div>
        </div>
      </div>
