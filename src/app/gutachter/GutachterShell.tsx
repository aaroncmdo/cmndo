  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mt-auto px-3 py-3 border-t border-white/10 space-y-2">
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-medium bg-white hover:bg-claimondo-bg transition-colors"
          ...
          <Link
            ...
            onClick={() => setSidebarOpen(false)}
            className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-medium hover:text-white hover:bg-white/5 transition-colors"
            style={{ color: 'var(--brand-sidebar-text)' }}
          >
            <SettingsIcon className="w-4 h-4" /> Einstellungen
          </Link>
          <button onClick={handleLogout}
            className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-medium hover:text-red-400 hover:bg-white/5 transition-colors"
            style={{ color: 'var(--brand-sidebar-text)' }}
          >
      ...
      >
        ...
        >
          {logoUrl && useBrand ? (
            <Link href="/gutachter" className="inline-flex items-center justify-center bg-white rounded-lg p-1 shadow-sm">
              <img
                src={logoUrl}
                alt={firmenname ? `${firmenname} Logo` : 'Logo'}
