...
const STATUS_COLOR: Record<string, string> = {
  ...
  besichtigung: 'bg-indigo-950 text-indigo-300',
...
export default async function GutachterFaellePage({
  ...
  return (
    <div className="px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          <h1 className="text-xl font-semibold text-white">Meine Faelle</h1>
          <p className="text-zinc-500 text-sm mt-0.5">{faelle?.length ?? 0} Faelle</p>
        </div>
        ...
        {!faelle?.length ? (
          <div className="bg-zinc-900 rounded-2xl p-12 text-center border border-zinc-800">
            <p className="text-zinc-500">Keine Faelle gefunden.</p>
          </div>
        ) : (
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-zinc-800">
                      ...
                      <th className="text-left px-4 py-3 text-zinc-400 font-medium">Schadentyp</th>
