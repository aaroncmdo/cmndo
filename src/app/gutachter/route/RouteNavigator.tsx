    ...
    return (
      <div className="fixed inset-0 z-50 bg-[#080c18] flex items-center justify-center p-6">
        <div className="text-center max-w-sm">
          ...
          <button onClick={handleEnd} className="w-full py-3.5 bg-[var(--brand-primary)] hover:bg-[var(--brand-secondary)] text-white font-semibold rounded-2xl transition-colors">
            ...
            {stops.map((_, i) => (
              <div key={i} className="flex items-center flex-1">
                <div className={`w-3 h-3 rounded-full border-2 shrink-0 ${
                  ...
                  statuses[i] === 'active' ? 'bg-[var(--brand-secondary)] border-[var(--brand-secondary)] shadow-[0_0_8px_rgba(59,130,246,0.6)]' :
        ...
        <div className={`flex-1 relative transition-all duration-300 ${inspecting ? 'h-[30%]' : panelExpanded ? 'h-[40%]' : 'h-[65%]'}`}>
          ...
          {currentStop && !inspecting && (
            <a
              ...
              className="absolute bottom-4 right-4 flex items-center gap-2 px-4 py-2.5 bg-[var(--brand-primary)] text-white text-sm font-medium rounded-xl shadow-lg"
            >
            ...
            {inspecting ? (
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  <button onClick={() => fileRef.current?.click()}
                    ...
                    <CameraIcon className="w-6 h-6 text-[var(--brand-accent)]" />
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  <div>
                    ...
                    <input value={fin} onChange={e => setFin(e.target.value.toUpperCase())} maxLength={17} placeholder="WBA..." className="w-full bg-gray-100 border border-gray-300 rounded-xl px-3 py-2.5 text-sm text-gray-900 font-mono placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[var(--brand-primary)]" />
                  ...
                  <div>
                    ...
                    <input value={schaetzung} onChange={e => setSchaetzung(e.target.value)} type="number" step="100" placeholder="z.B. 3500" className="w-full bg-gray-100 border border-gray-300 rounded-xl px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[var(--brand-primary)]" />
                  </div>
                </div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full bg-gray-100 border border-gray-300 rounded-xl px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 mb-4 focus:outline-none focus:ring-2 focus:ring-[var(--brand-primary)] resize-none"
                />
              ...
              <div>
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 bg-[var(--brand-secondary)]/20 rounded-full flex items-center justify-center">
                    <span className="text-[var(--brand-accent)] font-bold">{activeIdx + 1}</span>
                  </div>
                    ...
                    {stops.map((s, i) => (
                      <div key={s.id} className={`flex items-center gap-2 py-1.5 text-sm ${i === activeIdx ? 'text-gray-900' : 'text-gray-500'}`}>
                        <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0 ${
                          ...
                          statuses[i] === 'active' ? 'bg-[var(--brand-secondary)] text-white' :
                ...
                <div className="space-y-2">
                  <button onClick={handleArrive} disabled={saving}
                    className="w-full py-3.5 bg-[var(--brand-primary)] hover:bg-[var(--brand-secondary)] text-white font-semibold rounded-2xl transition-colors disabled:opacity-40 flex items-center justify-center gap-2 min-h-[56px]">
