  ...
  if (!org) {
    return (
      <div className="px-8 py-8 text-center">
        <p className="text-sm text-gray-500">Community nicht gefunden.</p>
      </div>
    )
  }
  ...
  return (
    <div className="px-8 py-8 max-w-5xl mx-auto">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
        <div className="px-5 py-3 border-b border-gray-200 bg-gradient-to-r from-amber-50 to-white">
                  ...
                  <tr key={row.sv_id} className={isMe ? 'bg-[#4573A2]/5 border-l-4 border-l-[#4573A2]' : ''}>
                    <td className="px-4 py-3">
                      <span className={`inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold ${
                        ...
                        : row.rang === 2 ? 'bg-gray-100 text-gray-700'
