        ...
        <div className="pt-4 border-t border-claimondo-border space-y-3">
          ...
          <div>
            ...
            <input
              ...
              maxLength={80}
              className="w-full bg-[#f8f9fb] border border-claimondo-border rounded-lg px-3 py-2 text-sm text-claimondo-navy focus:outline-none focus:ring-2 focus:ring-claimondo-ondo"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              maxLength={200}
              className="w-full bg-[#f8f9fb] border border-claimondo-border rounded-lg px-3 py-2 text-sm text-claimondo-navy focus:outline-none focus:ring-2 focus:ring-claimondo-ondo resize-none"
            />
