...
export default function PerformanceClient({ profile, stats, performanceHistory, incentives, leaderboard, monatLabel, userId, timeline, tagesSummary }: {
  ...
  return (
    <div className="py-8"><div>
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-gray-900 flex items-center gap-2"><BarChart3Icon className="w-5 h-5 text-claimondo-shield" />Meine Performance</h1>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5 mb-6">
          ...
          {tagesSummary && (
            <div className="flex items-center gap-4 mb-4 pb-3 border-b border-gray-200">
              <h2 className="text-gray-900 font-semibold flex items-center gap-2"><CalendarIcon className="w-4 h-4 text-claimondo-shield" />Heute</h2>
