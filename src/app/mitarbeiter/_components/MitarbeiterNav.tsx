...
// AAR-778: Shared PortalNav (dark variant, fixed Rail — PortalShell-Adoption).
// Header-/Footer-Slots tragen die frueher im Top-Bar gerenderten Aktionen.
      ...
      footerSlot={
        <>
          <div className="flex items-center gap-3 px-3 py-2.5">
            {/* Sidebar-Fuss unten-links → Popover nach oben-rechts. */}
