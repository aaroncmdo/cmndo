// Zentrale Site-Konfiguration · Kfz-Gutachter Aachen (Cluster-Vorlage für Nicolas).
...
export const SITE = {
  name: 'Kfz-Gutachter Aachen',
  shortName: 'Kfz-Gutachter Aachen',
  url: process.env.NEXT_PUBLIC_SITE_URL ?? 'https://kfz-unfallgutachter-aachen.de',
  locale: 'de_DE',
  lang: 'de',
