...
// Adresse = Betreiber-HQ (Koeln) — kein lokales Buero. aggregateRating aus dem
// GBP-Datenfeld (BRIEF 08i; Quelle Google-Bewertungen, im UI sichtbar — UWG).
...
// aus CLUSTER (z.B. "Markus Lennartz"). Cluster-level (Hub + alle Spokes identisch).
export function personSchema() {
  return {
    '@context': 'https://schema.org',
    '@type': 'Person',
    name: `${CLUSTER.svName} ${CLUSTER.svSurname}`,
    givenName: CLUSTER.svName,
    familyName: CLUSTER.svSurname,
